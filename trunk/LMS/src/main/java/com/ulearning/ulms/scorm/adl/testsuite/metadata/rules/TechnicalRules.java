...
public class TechnicalRules extends MetadataUtil
{
        ...
        public boolean verifyAssetMandatory()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("format"))
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "TechnicalRules::verifyAssetMandatory()",
                                        "Testing element " + elemNum + ".1 <format>...");
                                setMessage(MessageType.INFO,
                                        "TechnicalRules::verifyAssetMandatory()",
                                        "Testing element " + elemNum +
                                                ".1 <format> for multiplicity...");
                                ...
                                if (j > 40)
                                {
                                        setMessage(MessageType.WARNING,
                                                "TechnicalRules::verifyAssetMandatory()",
                                                "More than 40 <format> elements were found");
                                ...
                                else
                                {
                                        setMessage(MessageType.PASSED,
                                                "TechnicalRules::verifyAssetMandatory()",
                                                "40 or less <format> elements were found");
                        ...
                        if (!flag3)
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "TechnicalRules::verifyAssetMandatory()",
                                        "Testing element " + elemNum + ".3 <location>...");
                                setMessage(MessageType.INFO,
                                        "TechnicalRules::verifyAssetMandatory()",
                                        "Testing element " + elemNum +
                                                ".3 <location> for multiplicity...");
                                ...
                                if (k > 10)
                                {
                                        setMessage(MessageType.WARNING,
                                                "TechnicalRules::verifyAssetMandatory()",
                                                "More than 10 <location> elements were found");
                                }
                                else
                                {
                                        setMessage(MessageType.PASSED,
                                                "TechnicalRules::verifyAssetMandatory()",
                                                "10 or less <location> elements were found");
                                }
                ...
                if (!flag2)
                {
                        ...
                        setMessage(MessageType.FAILED,
                                "TechnicalRules::verifyAssetMandatory()",
                                "Element " + elemNum + ".1 <format> was not found and " +
                ...
                if (!flag3)
                {
                        ...
                        setMessage(MessageType.FAILED,
                                "TechnicalRules::verifyAssetMandatory()",
                                "element " + elemNum + ".3 <location> was not found and " +
                                        "must appear 1 or more times");
                }
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("size"))
                        {
                                if (!flag5)
                                {
                                        setMessage(MessageType.OTHER, "", "");
                                        setMessage(MessageType.INFO,
                                                "TechnicalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".2 <size>...");
                                        setMessage(MessageType.INFO,
                                                "TechnicalRules::verifyAssetOptional()",
                                                "Testing element 4.2 <size> for multiplicity...");
                                        ...
                                        if (j > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "TechnicalRules::verifyAssetOptional()",
                                                        "More than 1 <size> element was found...0 or 1 allowed");
                                                flag = false;
                                        }
                                        else
                                        {
                        ...
                        if (s.equalsIgnoreCase("requirement"))
                        {
                                if (!flag6)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "TechnicalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".4 <requirement>...");
                                        setMessage(MessageType.INFO,
                                                "TechnicalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".4 <requirement> for multiplicity...");
                                        ...
                                        if (k > 40)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "TechnicalRules::verifyAssetOptional()",
                                                        "More than 40 <requirement> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "TechnicalRules::verifyAssetOptional()",
                                                        "40 or less <requirement> elements were found");
                                        }

                                        flag6 = true;
                                }

                                RequirementRules requirementrules = new RequirementRules(node1,
                                        elemNum + ".4");
                        ...
                        if (s.equalsIgnoreCase("installationremarks"))
                        {
                                if (!flag7)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "TechnicalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".5 <installationremarks>...");
                                        setMessage(MessageType.INFO,
                                                "TechnicalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".5 <installationremarks> for multiplicity...");
                                        ...
                                        if (l > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "TechnicalRules::verifyAssetOptional()",
                                                        "More than 1 <installationremarks> element was found...0 or 1 allowed");
                                                flag2 = false;
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "TechnicalRules::verifyAssetOptional()",
                                                        "0 or 1 <installationremarks> element was found");
                        ...
                        if (s.equalsIgnoreCase("otherplatformrequirements"))
                        {
                                if (!flag8)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "TechnicalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".6 <otherplatformrequirements>...");
                                        setMessage(MessageType.INFO,
                                                "TechnicalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".6 <otherplatformrequirements> for " +
                                                        "multiplicity...");
                                        ...
                                        if (i1 > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "TechnicalRules::verifyAssetOptional()",
                                                        "More than 1 <otherplatformrequirements> element was found...0 or 1 allowed");
                                                flag3 = false;
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "TechnicalRules::verifyAssetOptional()",
                                                        "0 or 1 <otherplatformrequirements> element was found");

                                                if (!verifyOtherplatformrequirements(node1,
                                                        elemNum + ".6"))
                                                {
                                                        flag3 = false;
                                                }
                        ...
                        if (!flag9)
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "TechnicalRules::verifyAssetOptional()",
                                        "Testing element " + elemNum + ".7 <duration>...");
                                setMessage(MessageType.INFO,
                                        "TechnicalRules::verifyAssetOptional()",
                                        "Testing element " + elemNum +
                                                ".7 <duration> for multiplicity...");
                                ...
                                if (j1 > 1)
                                {
                                        setMessage(MessageType.FAILED,
                                                "TechnicalRules::verifyAssetOptional()",
                                                "More than 1 <duration> element was found...0 or 1 allowed");
                                        flag4 = false;
                                }
                                else
                                {
                                        setMessage(MessageType.PASSED,
                                                "TechnicalRules::verifyAssetOptional()",
                                                "0 or 1 <duration> element was found");
        ...
        private boolean verifyFormat(Node node, String s)
        {
                ...
                if (nodelist != null)
                {
                        ...
                        if (i == 0)
                        {
                                flag = false;
                                setMessage(MessageType.FAILED,
                                        "TechnicalRules::verifyFormat()",
                                        "No data was found in element <format> and fails the minimum character length test");
                        }
                        else if (i == 1)
                        {
                        ...
                        else
                        {
                                ...
                                setMessage(MessageType.FAILED,
                                        "GeneralRules::verifyLanguage()",
                                        "Too many text strings were found in <language> and fails the test");
                        }
                }
        ...
        private boolean verifySize(Node node, String s)
        {
                ...
                if (nodelist != null)
                {
                        ...
                        {
                                flag = false;
                                setMessage(MessageType.FAILED, "TechnicalRules::verifySize()",
                                        "No data was found in element <size> and fails the minimum character length test");
                        }
                        else if (i == 1)
                        {
                                for (int k = 0; k < nodelist.getLength(); k++)
                                {
                                        ...
                                        {
                                                setMessage(MessageType.INFO,
                                                        "TechnicalRules::verifySize()",
                                                        "Testing element " + s + " <size> for " +
                                                                "digital resource in bytes...");
                                                ...
                                                try
                                                {
                                                        ...
                                                        if (long1.compareTo(new Long("0")) < 0)
                                                        {
                                                                setMessage(MessageType.FAILED,
                                                                        "TechnicalRules::verifySize()",
                                                                        "Text in element " + s + " <size> " +
                                                                                "was not a byte and fails the digital " +
                                                                                "resource in bytes test");
                                                                setMessage(MessageType.FAILED,
                                                                        "TechnicalRules::verifySize()",
                                                                        "value = " + s2);
                                                                flag = false;
                                                ...
                                                catch (NumberFormatException numberformatexception)
                                                {
                                                        setMessage(MessageType.FAILED,
                                                                ...
                                                                "Text in element " + s + " <size> " +
                                                                        ...
                                                                        "resource in bytes test");
                                                        setMessage(MessageType.FAILED,
                                                                "TechnicalRules::verifySize()", "value = " +
                                                                s2);
                                                        flag = false;
                                                }
                                                ...
                                                if (flag)
                                                {
                                                        setMessage(MessageType.PASSED,
                                                                "TechnicalRules::verifySize()",
                                                                "Digital resource in bytes for element " + s +
                                                ...
                                                else if (s2.length() < 1)
                                                {
                                                        ...
                                                        setMessage(MessageType.FAILED,
                                                                "TechnicalRules::verifySize()",
                                                                "No text was found in element " + s +
                                                                        " <size> and fails the minimum character " +
                                                                        "length test");
                                                }
                                                else
                                                {
                                                        setMessage(MessageType.PASSED,
                                                                "TechnicalRules::verifySize()",
                                                                "Character length for element  <size> has been verified");
                                                }
                                        }
                                }
                        }
                        else
                        {
                                ...
                                setMessage(MessageType.FAILED, "TechnicalRules::verifySize()",
                                        "Too many text strings were found in <size> and fails the test");
                        }
                }
        ...
        private boolean verifyLocation(Node node, String s)
        {
                ...
                if (nodelist != null)
                {
                        ...
                        if (i == 0)
                        {
                                flag = false;
                                setMessage(MessageType.FAILED,
                                        "TechnicalRules::verifyLocation()",
                                        "No data was found in element <location> and fails the minimum character length test");
                        }
                        else if (i == 1)
                        {
                                for (int k = 0; k < nodelist.getLength(); k++)
                                {
                                                ...
                                                (node3.getNodeType() == 4))
                                        {
                                                ...
                                                setMessage(MessageType.INFO,
                                                        "TechnicalRules::verifyLocation()",
                                                        "Testing text of element " + s +
                                                                " <location> for character length...");
                                                ...
                                                if (s2.length() > c)
                                                {
                                                        setMessage(MessageType.WARNING,
                                                                "TechnicalRules::verifyLocation()",
                                                                "The text contained in element " + s +
                                                                        " <location> is greater than " + (int) c);
                                                }
                                                else if (s2.length() < 1)
                                                {
                                                        flag = false;
                                                        setMessage(MessageType.FAILED,
                                                                "TechnicalRules::verifyLocation()",
                                                                "No text was found in element " + s +
                                                                        " <location> and fails the minimum " +
                                                                        "character length test");
                                                }
                                                else
                                                {
                                                        setMessage(MessageType.PASSED,
                                                                "TechnicalRules::verifyLocation()",
                                                                "Character length for element  <location> has been verified");
                                                }
                                        }
                                }
                        }
                        else
                        {
                                ...
                                setMessage(MessageType.FAILED,
                                        "TechnicalRules::verifyLocation()",
                                        "Too many text strings were found in <location> and fails the test");
                        }
                }
        ...
        private boolean verifyDuration(Node node, String s)
        {
                ...
                boolean flag6 = false;
                setMessage(MessageType.INFO,
                        "TechnicalRules::verifyTypicallearningtime()",
                        "Testing element " + s + " <duration> for " +
                                "element <datetime>...");
                ...
                if (!flag5)
                {
                        setMessage(MessageType.INFO, "TechnicalRules::verifyRole()",
                                "Testing element <datetime> for multiplicity...");
                        setMessage(MessageType.FAILED, "TechnicalRules::verifyRole()",
