...
public class GeneralRules extends MetadataUtil
{
        ...
        public boolean verifyAssetMandatory()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("title"))
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "GeneralRules::verifyAssetMandatory()",
                                        "Testing element " + elemNum + ".2 <title>...");
                                setMessage(MessageType.INFO,
                                        "GeneralRules::verifyAssetMandatory()",
                                        "Testing element " + elemNum +
                                                ".2 <title> for multiplicity...");
                                ...
                                if (j > 1)
                                {
                                        setMessage(MessageType.FAILED,
                                                "GeneralRules::verifyAssetMandatory()",
                                                "More than 1 <title> element was found .. 1 and only 1 allowed");
                                        flag = false;
                                }
                                else if (j == 1)
                                {
                                        setMessage(MessageType.PASSED,
                                                "GeneralRules::verifyAssetMandatory()",
                                                "1 and only 1 <title> element was found");
                        ...
                        if (s.equalsIgnoreCase("description"))
                        {
                                if (!flag3)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyAssetMandatory()",
                                                "Testing element " + elemNum + ".5 <description>...");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyAssetMandatory()",
                                                "Testing element 1.5 <description> for multiplicity...");
                                        ...
                                        if (k > 10)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "GeneralRules::verifyAssetMandatory()",
                                                        "More than 10 <description> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "GeneralRules::verifyAssetMandatory()",
                                                        "10 or less <description> elements were found");
                                        }
                        ...
                        if (s.equalsIgnoreCase("identifier"))
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "GeneralRules::verifyAssetMandatory()",
                                        "Testing element 1 <general> for reserved element <identifier>..");
                                setMessage(MessageType.FAILED,
                                        "GeneralRules::verifyAssetMandatory()",
                                        "Element 1.1 <identifier> was found and is a Reserved element");
                        }
                }
                ...
                if (!flag2)
                {
                        setMessage(MessageType.INFO,
                                "GeneralRules::verifyAssetMandatory()",
                                "Testing element 1.2 <title> for multiplicity...");
                        setMessage(MessageType.FAILED,
                                "GeneralRules::verifyAssetMandatory()",
                                "Element 1.2 <title> was not found and must appear 1 and only 1 time");
                }
                ...
                if (!flag3)
                {
                        ...
                        setMessage(MessageType.FAILED,
                                "GeneralRules::verifyAssetMandatory()",
                                "Element 1.5 <description> was not found and must appear 1 or more times");
                }
        ...
        public boolean verifyScoMandatory()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("title"))
                        {
                                if (!flag4)
                                {
                                        setMessage(MessageType.OTHER, "", "");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyScoMandatory()",
                                                "Testing element " + elemNum + ".2 <title>...");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyScoMandatory()",
                                                "Testing element " + elemNum +
                        ...
                        if (s.equalsIgnoreCase("catalogentry"))
                        {
                                if (!flag5)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyScoMandatory()",
                                                "Testing element " + elemNum + ".3 <catalogentry>...");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyScoMandatory()",
                                                "Testing element " + elemNum +
                                                        ".3 <catalogentry> for multiplicity...");
                                        ...
                                        if (k > 10)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "GeneralRules::verifyScoMandatory()",
                                                        "More than 10 <catalogentry> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "GeneralRules::verifyScoMandatory()",
                                                        "10 or less <catalogentry> elements were found");
                                        }

                                        flag5 = true;
                                }

                                CatalogentryRules catalogentryrules = new CatalogentryRules(node1,
                                        elemNum + ".3");
                        ...
                        if (s.equalsIgnoreCase("description"))
                        {
                                if (!flag6)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyScoMandatory()",
                                                "Testing element element " + elemNum +
                                                        ".5 <description> for multiplicity...");

                                        int l = getMultiplicityUsed(generalNode, s);

                                        if (l > 10)
                                        {
                                                setMessage(MessageType.WARNING, "verifyScoMandatory()",
                                                        "More than 10 <description> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED, "verifyScoMandatory()",
                                                        "10 or less <description> elements were found");
                                        }
                        ...
                        if (s.equalsIgnoreCase("keyword"))
                        {
                                if (!flag7)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyScoMandatory()",
                                                "Testing element " + elemNum + ".6 <keyword>...");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyScoMandatory()",
                                                "Testing element " + elemNum +
                                                        ".6 <keyword> for multiplicity...");
                                        ...
                                        {
                                                setMessage(MessageType.WARNING, "verifyScoMandatory()",
                                                        "More than 10 <keyword> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED, "verifyScoMandatory()",
                                                        "10 or less <keyword> elements were found");
                                        }
                ...
                if (!flag4)
                {
                        setMessage(MessageType.INFO, "GeneralRules::verifyScoMandatory()",
                                "Testing element " + elemNum + " .2 <title> for " +
                                        "multiplicity...");
                        setMessage(MessageType.FAILED,
                                "GeneralRules::verifyScoMandatory()",
                                "Element " + elemNum + ".2 <title> was not found and " +
                ...
                {
                        setMessage(MessageType.INFO, "GeneralRules::verifyScoMandatory()",
                                "Testing element " + elemNum + ".3 <catalogentry> for " +
                                        "multiplicity...");
                        setMessage(MessageType.FAILED,
                                "GeneralRules::verifyScoMandatory()",
                                "Element " + elemNum + ".3 <catalogentry> was not found and " +
                ...
                {
                        setMessage(MessageType.INFO, "GeneralRules::verifyScoMandatory()",
                                "Testing element " + elemNum + ".5 <description> for " +
                                        "multiplicity...");
                        setMessage(MessageType.FAILED,
                                "GeneralRules::verifyScoMandatory()",
                                "Element " + elemNum + ".5 <description> was not found and " +
                                        "must appear 1 or more times");
                }
                ...
                {
                        setMessage(MessageType.INFO, "GeneralRules::verifyScoMandatory()",
                                "Testing element " + elemNum + ".6 <keyword> for " +
                                        "multiplicity...");
                        setMessage(MessageType.FAILED,
                                "GeneralRules::verifyScoMandatory()",
                                "Element " + elemNum + ".6 <keyword> was not found and " +
                                        "must appear 1 or more times");
                }

                if (com.ulearning.ulms.scorm.adl.util.debug.DebugIndicator.ON)
                {
                        boolean flag11 = flag && flag1 && flag2 && flag3 && flag4 && flag5 &&
                                flag6 && flag7;
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("catalogentry"))
                        {
                                if (!flag6)
                                {
                                        setMessage(MessageType.OTHER, "", "");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".3 <catalogentry>...");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                        ...
                        if (s.equalsIgnoreCase("language"))
                        {
                                if (!flag7)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".4 <language>...");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".4 <language> for multiplicity...");
                                        ...
                                        if (k > 10)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "GeneralRules::verifyAssetOptional()",
                                                        "More than 10 <language> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "GeneralRules::verifyAssetOptional()",
                                                        "10 or less <language> elements were found");
                                        }
                        ...
                        if (s.equalsIgnoreCase("coverage"))
                        {
                                if (!flag9)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".7 <coverage>...");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".7 <coverage> for multiplicity...");
                                        ...
                                        if (i1 > 10)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "GeneralRules::verifyAssetOptional()",
                                                        "More than 10 <coverage> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "GeneralRules::verifyAssetOptional()",
                                                        "10 or less <coverage> elements were found");
                                        }
                        ...
                        if (s.equalsIgnoreCase("structure"))
                        {
                                if (!flag10)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".8 <structure>...");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".8 <structure> for multiplicity...");
                                        ...
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "GeneralRulesRules::verifyAssetOptional()",
                                                        "More than 1 <structure> element was found .. 0 or 1 allowed");
                                                flag4 = false;
                                        }
                                        else if (j1 == 1)
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "GeneralRules::verifyAssetOptional()",
                                                        "0 or 1 <structure> element was found");
                        ...
                        if (s.equalsIgnoreCase("aggregationlevel"))
                        {
                                if (!flag11)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".9 <aggregationlevel> for multiplicity...");
                                        ...
                                        if (k1 > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "GeneralRules::verifyAssetOptional()",
                                                        "More than 1 <aggregationlevel> element was found .. 0 or 1 allowed");
                                                flag5 = false;
                                        }
                                        else if (k1 == 1)
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "GeneralRules::verifyAssetOptional()",
                                                        "0 or 1 <aggregationlevel> element was found");
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("language"))
                        {
                                if (!flag4)
                                {
                                        setMessage(MessageType.OTHER, "", "");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyScoOptional()",
                                                "Testing element " + elemNum + ".5 <language>...");
                                        setMessage(MessageType.INFO,
                                                "GeneralRules::verifyScoOptional()",
                                                "Testing element " + elemNum +
                                                        ".4 <language> for multiplicity...");
                        ...
                        if (s.equalsIgnoreCase("structure"))
                        {
                                if (!flag6)
                                {
                                        ...
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "GeneralRulesRules::verifyScoOptional()",
                                                        "More than 1 <structure> element was found .. 0 or 1 allowed");
                                                flag2 = false;
                                        }
                                        else if (l == 1)
                ...
                if (nodelist != null)
                {
                        ...
                        if (i == 0)
                        {
                                ...
                                setMessage(MessageType.FAILED,
                                        ...
                                        "No data was found in element <language> and fails the minimum character length test");
                        }
                        else if (i == 1)
                        {
                                for (int k = 0; k < nodelist.getLength(); k++)
                                {
                                                ...
                                                (node3.getNodeType() == 4))
                                        {
                                                setMessage(MessageType.INFO,
                                                        "GeneralRules::verifyLanguage()",
                                                        "Testing element " + s + " <language> for " +
                                                                "character length...");
                                                ...
                                                if (s2.length() > byte0)
                                                {
                                                        setMessage(MessageType.WARNING,
                                                                ...
                                                                "The text contained in element " + s +
                                                                        " <language> is greater than " + byte0);
                                                }
                                                else if (s2.length() < 1)
                                                {
                                                        flag = false;
                                                        setMessage(MessageType.FAILED,
                                                                ...
                                                                "No text was found in element " + s +
                                                                        " <language> and fails the minimum " +
