...
public class ChineseCalendarGB
{
        ...
        public ChineseCalendarGB(int y, int m, int d)
        {
                 setGregorian(y,m,d);
        }

        public ChineseCalendarGB(Date date)
        {
        ...
        public ChineseCalendarGB(java.util.Calendar cal)
        {
                int y=cal.get(java.util.Calendar.YEAR);
                int m=cal.get(java.util.Calendar.MONTH)+1;
                int d=cal.get(java.util.Calendar.DAY_OF_MONTH);
        ...
        public void setGregorian(java.util.Calendar cal)
        {
                int y=cal.get(java.util.Calendar.YEAR);
                int m=cal.get(java.util.Calendar.MONTH)+1;
                int d=cal.get(java.util.Calendar.DAY_OF_MONTH);
        ...
        public int computeChineseFields()
        {
                ...
                lunarYear=chineseYear-baseChineseYear+baseYear-1;
                return 0;
        }
         ...
         * @return
         */
        public  void computeTianGanDiZhi()
        {
                int m_cur = 0;
                int m_this = 0;
                int tian = 0;
                ...
                for (int i = 0; i < 60; i++)
                {
                        ...
                        if (m_this == m_index)
                        {
                                tianGanDizhi=TianGan[tian] + DiZhi[di];
        ...
        /**
         * 返回天干地支，如2007，返回 农历丁亥年，猪年
         *
         * @return
         */
        public  String getTianGanDiZhiStr()
        {

                String buffer = "农历";
                buffer = buffer + tianGanDizhi + "年，" + shuXiang + "年";
                return (buffer);
        }
