 ...
 */
public class ContentCatalogModel implements Serializable
{
        /**
         * identifier field
         */
         ...
         * full constructor
         */
        public ContentCatalogModel(int parentID, int relationID, String type,
         ...
         * minimal constructor
         */
        public ContentCatalogModel(int parentID, int relationID, String title)
        {
                this.parentID = parentID;
                this.relationID = relationID;
                this.title = title;
