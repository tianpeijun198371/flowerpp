...
public class CMITime implements Serializable
{
        ...
        public CMITime(String timeString)
        {
                ...
                {
                        System.out.println("[CMITime]LMSFinish-----eror=" +
                                nsee.getMessage());
                }
        ...
        String sessiontime = "00:00:18.17";
        String totletime = "00:00:0.0";
        CMITime sessionTime = new CMITime(sessiontime);
        CMITime totalTime = new CMITime(totletime);
        System.out.println("sessionTime = " + sessionTime.getSeconds());
        }*/
}
