 ...
 ** Company Name: CTC
 **
 ** Module/Package Name: com.ulearning.ulms.scorm.lms.client
...
public class ServletProxy
{
        ...
        {
                //System.out.println("[servletProxy]GetSCOData   In ServletProxy:GetSCOData()");
                ...
                try
                {
                        ...
                        //System.out.println("[servletProxy]GetSCOData --Before postObjects()");
                        //System.out.println("[servletProxy]GetSCOData --this.servletUR=" +this.servletURL);
                        //System.out.println("[servletProxy]GetSCOData --data=" + data);
                        //System.out.println("[servletProxy]GetSCOData --sessionid=" +sessionid);

                        ObjectInputStream in = ServletWriter.postObjects(this.servletURL,
                                data, sessionid);

                        //System.out.println("[servletProxy]]Back In ServletProxy::GetSCOData()");
                        //System.out.println("[servletProxy]]Attempting to read servlet response now...");

                        // Read the SCODataManager off of the Object Input Stream
                        SCODataManager scoData = (SCODataManager) in.readObject();

                        //System.out.println("[servletProxy]]Read servlet response successfully.");
                        //System.out.println("[servletProxy]]Closing input stream");
                ...
                {
                        //System.out.println("[servletProxy]Exception caught In ServletProxy::GetSCODataData()");
                        //System.out.println("[servletProxy]Exception--" + e.getMessage());
                        e.printStackTrace();
        ...
        public String PutSCOData(SCODataManager scoData)
        {
                try
                {
                        //System.out.println("[servletProxy]--In ServletProxy::PutSCOData()");
                ...
                {
                        //System.out.println("[servletProxy]Exception caught In ServletProxy::PutSCOData()");
                        //System.out.println("[servletProxy]Exception:" + e.getMessage());
