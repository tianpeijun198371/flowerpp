...
public class CMIStudentData extends CMICategory implements Serializable
{
        ...
        public CMIStudentData()
        {
                ...
                super(true);
                mastery_score = new Element("", "checkDecimal", "NULL", false, true,
                        false);
                max_time_allowed = new Element("", "checkTimespan", "NULL", false,
                        true, false);
                time_limit_action = new Element("", "checkVocabulary",
                        "TimeLimitAction", false, true, false);
