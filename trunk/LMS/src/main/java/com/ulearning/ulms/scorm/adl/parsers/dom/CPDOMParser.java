...
import com.ulearning.ulms.scorm.adl.testsuite.metadata.MetaDataTester;
import com.ulearning.ulms.scorm.adl.testsuite.util.AuditorIndicator;
...
//            ADLDOMParser, ADLManifest, ADLMetadata
public class CPDOMParser extends ADLDOMParser
{
        ...
        public boolean setControlDocs()
        {
                ...
                for (int l = 0; l < k; l++)
                {
                        ...
                        try
                        {
                                attr.setNodeValue(s4 + " ..\\..\\..\\..\\..\\ims_xml.xsd " +
                                        s5 + " ..\\..\\..\\..\\..\\imscp_rootv1p1p2.xsd " + s6 +
                                        " ..\\..\\..\\..\\..\\imsmd_rootv1p2.xsd " + s7 +
                                        " ..\\..\\..\\..\\..\\adl_cp_rootv1p1.xsd");
                        ...
                        {
                                s1 = "Error in setting the value for xsi.schemaLocation.";
                        }
        ...
        public boolean setControlDocsProperty()
        {
                ...
                try
                {
                        setProperty("http://apache.org/xml/properties/external-schemaLocation",
                                s6 + " ..\\..\\..\\..\\..\\ims_xml.xsd " + s7 +
                                        " ..\\..\\..\\..\\..\\imscp_rootv1p1p2.xsd " + s9 +
                                        " ..\\..\\..\\..\\..\\adl_cp_rootv1p1.xsd" + s8 +
                                        " ..\\..\\..\\..\\..\\imsmd_rootv1p2.xsd ");
                }
        ...
        public boolean checkMetadata()
        {
                ...
                for (int j1 = 0; j1 < i1; j1++)
                {
                        ...
                        try
                        {
                                ...
                                {
                                        if ((s8.length() > 6) &&
                                                (s8.substring(0, 5).equals("http:") ||
                                                        s8.substring(0, 6).equals("https:")))
                                        {
                                                flag3 = true;
                                        ...
                                        else if (testType.equals("media") && !flag3)
                                        {
                                                s8 = filePath + s8;
                                        }
                                }
                        ...
                        String s2 = "<a href=\\\"" + s13 +
                                "\\\" target=\\\"_blank\\\">Click here to view complete meta-data test log</a><br>";
        ...
        public boolean startValidateTest(String s, String s1, Node node,
                                         FileWriter filewriter)
        {
                ...
                boolean flag4 = true;
                String s3 = "";
                String s11 = messageLocation + "startValidateTest()";
                String s12 = "";
                int i = MessageClassification.METADATA;
                ...
                if (s1 != "")
                {
                        ...
                        messageHandler.addMessage(i, j, s3, s11, s12, filewriter);
                ...
                int k = MessageType.OTHER;
                s3 = "***************************************************";
                messageHandler.addMessage(i, k, s3, s11, s12, filewriter);
                k = MessageType.INFO;
                s3 = "Meta-Data Test Conformance Summary";
                messageHandler.addMessage(i, k, s3, s11, s12);
                k = MessageType.OTHER;
                s3 = "***************************************";
                messageHandler.addMessage(i, k, s3, s11, s12, filewriter);
                k = MessageType.INFO;
                ...
                if (com.ulearning.ulms.scorm.adl.util.debug.DebugIndicator.ON)
                {
                        System.out.println("metadataTester.isWellFormed() " +
                                metadatatester.isWellFormed());
                }
                ...
                if (flag5)
                {
                        ...
                        if (!s.equalsIgnoreCase("package"))
                        {
                                ...
                                {
                                        System.out.println(
                                                "Checking the Meta-data for mandatory elements");
                                }
                                ...
                                {
                                        System.out.println(
                                                "Checking the Meta-data for optional elements");
                                }
                ...
                if (!s.equalsIgnoreCase("package"))
                {
                        if (flag && flag1 && flag3)
                        {
                                ...
                                messageHandler.addMessage(i, l, s4, s11, s12);
                                messageHandler.addMessage(i, l, s4, s11, s12, filewriter);

                                if (DebugIndicator.ON)
                                {
                                        System.out.println(
                                                "Meta-data is SCORM Version 1.2 MD-XML1 + Optional Extensions Conformant");
                                }
                        ...
                        else if (flag && flag1)
                        {
                                ...
                                messageHandler.addMessage(i, i1, s5, s11, s12);
                                messageHandler.addMessage(i, i1, s5, s11, s12, filewriter);

                                if (com.ulearning.ulms.scorm.adl.util.debug.DebugIndicator.ON)
                                {
                                        System.out.println(
                                                "The Meta-data is SCORM Version 1.2 MD-XML1 + Optional Conformant");
                                }
                        ...
                        else if (flag && flag3)
                        {
                                ...
                                messageHandler.addMessage(i, j1, s6, s11, s12);
                                messageHandler.addMessage(i, j1, s6, s11, s12, filewriter);

                                if (com.ulearning.ulms.scorm.adl.util.debug.DebugIndicator.ON)
                                {
                                        System.out.println(
                                                "The Meta-data is SCORM Version 1.2 MD-XML1 + Extensions Conformant");
                                }
                        ...
                        else if (flag)
                        {
                                ...
                                messageHandler.addMessage(i, k1, s7, s11, s12);
                                messageHandler.addMessage(i, k1, s7, s11, s12, filewriter);

                                if (com.ulearning.ulms.scorm.adl.util.debug.DebugIndicator.ON)
                                {
                                        System.out.println(
                                                "The Meta-data is SCORM Version 1.2 MD-XML1 Conformant");
                                }
                        ...
                        else
                        {
                                ...
                                messageHandler.addMessage(i, l1, s8, s11, s12);
                                messageHandler.addMessage(i, l1, s8, s11, s12, filewriter);
                ...
                {
                        int i2 = MessageType.TERMINATE;
                        String s9 = "The Meta-data is Non-Conformant<br>";
                        messageHandler.addMessage(i, i2, s9, s11, s12);
                        messageHandler.addMessage(i, i2, s9, s11, s12, filewriter);
                ...
                {
                        int j2 = MessageType.OTHER;
                        String s10 = "";
                        messageHandler.addMessage(i, j2, s10, s11, s12, filewriter);
                        j2 = MessageType.INFO;
                        s10 = "Successful outcome of this test does not constitute ADL Certification unless the test was conducted by an ADL Accredited Auditor.";
                        messageHandler.addMessage(i, j2, s10, s11, s12, filewriter);
                }
        ...
        private void reportMessages(Message[] amessage, boolean flag,
                                    FileWriter filewriter)
        {
                String s = "";
