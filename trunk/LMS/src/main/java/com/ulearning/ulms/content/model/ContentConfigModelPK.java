 ...
 */
public class ContentConfigModelPK implements Serializable
{
        /**
         * identifier field
         */
         ...
         * full constructor
         */
        public ContentConfigModelPK(String type, int relationID)
        {
                this.type = type;
        ...
        public boolean equals(Object other)
        {
                ...
                if (!(other instanceof ContentConfigModelPK))
                {
                        return false;
                }

                ContentConfigModelPK castOther = (ContentConfigModelPK) other;
