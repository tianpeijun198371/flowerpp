/**
 * ScormDAODB2.java.
 * User: fengch Date: 2006-3-9 18:38:27
 *
...
public class ScormDAODB2 extends ScormDAOImpl
{
        /**
                               ...
                               Vector items) throws ScormSysException
        {
                ...
                LogUtil.debug("scorm",
                        "[ScormDAODB2]insertItem--***********************relationID=" +
                                relationID);
                LogUtil.debug("scorm",
                        "[ScormDAODB2]insertItem--***********************type=" + type);
                LogUtil.debug("scorm",
                        "[ScormDAODB2]insertItem--***********************courseContentNodeID=" +
                                courseContentNodeID);
                ...
                String sqlInsertItem = "INSERT INTO C_Item_Tab (ItemID,RelationID,Type,CourseContentNodeID," +
                        ...
                        "VALUES(NEXT VALUE FOR ItemID,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

                LogUtil.debug("scorm",
                        "[ScormDAODB2]insertItem--***********************sqlInsertItem=" +
                                sqlInsertItem);
                ...
                try
                {
                        ...
                        LogUtil.debug("scorm",
                                "[ScormDAODB2]insertItem--***********************items.size=" +
                                        items.size());
