        ...
        public boolean verifyAssetMandatory()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("metadatascheme"))
                        {
                                if (!flag1)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "MetametadataRules::verifyAssetMandatory()",
                                                "Testing element " + elemNum +
                                                        ".4 <metadatascheme>...");
                                        setMessage(MessageType.INFO,
                                                "MetametadataRules::verifyAssetMandatory()",
                                                "Testing element " + elemNum +
                                                        ".4 <metadatascheme> for " + "multiplicity...");
                                        ...
                                        if (j > 10)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "MetametadataRules::verifyAssetMandatory()",
                                                        "More than 10 <metadatascheme> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "MetametadataRules::verifyAssetMandatory()",
                                                        "10 or less <metadatascheme> elements were found");
                                        }
                        ...
                        if (s.equalsIgnoreCase("identifier"))
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "MetametadataRules::verifyAssetMandatory()",
                                        "Testing element 3 <metametadata> for reserved element <identifier>..");
                                setMessage(MessageType.FAILED,
                                        "MetametadataRules::verifyAssetMandatory()",
                                        "Element 3.1 <identifier> was found and is a Reserved  element");
                        }
                }
                ...
                if (!flag1)
                {
                        setMessage(MessageType.INFO,
                                "MetametadataRules::verifyAssetMandatory()",
                                "Testing element 3.4 <metadatascheme> for multiplicity...");
                        setMessage(MessageType.FAILED,
                                "MetametadataRules::verifyAssetMandatory()",
                                "Element 3.4 <metadatascheme> was not found and must appear 1 or more times");
                }
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("catalogentry"))
                        {
                                if (!flag3)
                                {
                                        setMessage(MessageType.OTHER, "", "");
                                        setMessage(MessageType.INFO,
                                                "MetametadataRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".2 <catalogentry>...");
                                        setMessage(MessageType.INFO,
                                                "MetametadataRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".2 <catalogentry> for multiplicity...");
                        ...
                        if (s.equalsIgnoreCase("contribute"))
                        {
                                if (!flag4)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "MetametadataRules::verifyAssetOptional()",
                                                "Testing element 3.3 <contribute> for multiplicity...");
                                        ...
                                        if (k > 10)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "MetametadataRules::verifyAssetOptional()",
                                                        "More than 10 <contribute> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "MetametadataRules::verifyAssetOptional()",
                                                        "10 or less <contribute> elements were found");
                                        }
                        ...
                        if (s.equalsIgnoreCase("language"))
                        {
                                if (!flag5)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                ...
                                                "Testing element 3..5 <language> for multiplicity...");
                                        ...
                                        if (l > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "MetametadataRules::verifyAssetOptional()",
                                                        "More than 1 <languge> element was found...0 or 1 allowed");
                                                flag2 = false;
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "MetametadataRules::verifyAssetOptional()",
                                                        "0 or 1 <language> element was found");
        ...
        private boolean verifyMetadatascheme(Node node, String s)
        {
                ...
                if (nodelist != null)
                {
                        ...
                        if (i == 0)
                        {
                                flag = false;
                                setMessage(MessageType.FAILED,
                                        "MetametadataRules::verifyMetadatascheme()",
                                        "No data was found in element <metadatascheme> and fails the minimum character length test");
                        }
                        else if (i == 1)
                        {
                                for (int k = 0; k < nodelist.getLength(); k++)
                                {
                                                ...
                                                (node3.getNodeType() == 4))
                                        {
                                                setMessage(MessageType.INFO,
                                                        "MetametadataRules::verifyMetadatascheme()",
                                                        "Testing text of element <metadatascheme> for character length...");
                                                ...
                                                if (s2.length() > byte0)
                                                {
                                                        setMessage(MessageType.WARNING,
                                                                "MetametadataRules::verifyMetadatascheme()",
                                                                "The text contained in element <metadatascheme> is greater than " +
                                                                        byte0);
                                                }
                                                else if (s2.length() < 1)
                                                {
                                                        ...
                                                        setMessage(MessageType.FAILED,
                                                                "MetametadataRules::verifyMetadatascheme()",
                                                                "No text was found in element <metadatascheme> and fails the minimum character length test");
                                                }
                                                else
                                                {
                                                        setMessage(MessageType.PASSED,
                                                                "MetametadataRules::verifyMetadatascheme()",
                                                                "Character length for element <metadatascheme> has been verified");
                                                }
                                        }
                                }
                        }
                        else
                        {
                                ...
                                setMessage(MessageType.FAILED,
                                        "MetametadataRules::verifyMetadatascheme()",
                                        "Too many text strings were found in <metadatascheme> and fails the test");
                        }
                }
                ...
                if (nodelist != null)
                {
                        ...
                        else if (i <= 1)
                        {
                                for (int k = 0; k < nodelist.getLength(); k++)
                                {
                                        ...
                                        {
                                                setMessage(MessageType.INFO,
                                                        "MetametadataRules::verifyLanguage()",
                                                ...
                                                {
                                                        setMessage(MessageType.PASSED,
                                                                "MetametadataRules::verifyverifyLanguage()",
