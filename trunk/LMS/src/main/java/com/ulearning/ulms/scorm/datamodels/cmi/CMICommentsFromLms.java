...
public class CMICommentsFromLms extends CMICategory implements Serializable
{
        // Instructor comments
        ...
        {
                super(true);
                comments_from_lms = new Element("", "checkString4096", "NULL", false,
                        true, false);
                ...
                if (theRequest.hasMoreTokensToProcess())
                {
                        if (true)
                        {
                                ...
                                System.out.println("Element being processed: " +
                                        ...
                                        "element of the CMI Suspend Data " + "Data Model Category");
                        }
