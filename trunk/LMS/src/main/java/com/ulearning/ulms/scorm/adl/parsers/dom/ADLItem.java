...
public class ADLItem extends ADLElement implements Serializable
{
        ...
        public ADLItem()
        {
                ...
                idExists = false;
                level = 0;
                prerequisitesMultiplicityUsed = 0;
                maxTimeAllowedMultiplicityUsed = 0;
                timeLimitActionMultiplicityUsed = 0;
                dataFromLMSMultiplicityUsed = 0;
                masteryScoreMultiplicityUsed = 0;
        ...
        public boolean fillItem(Node node, Vector vector)
        {
                ...
                for (int k = 0; k < nodelist.getLength(); k++)
                {
                        ...
                        if (node1.getLocalName().equalsIgnoreCase("item"))
                        {
                                ...
                                prerequisitesMultiplicityUsed = getMultiplicityUsed(node1,
                                        "prerequisites");
                                maxTimeAllowedMultiplicityUsed = getMultiplicityUsed(node1,
                                        "maxtimeallowed");
                                timeLimitActionMultiplicityUsed = getMultiplicityUsed(node1,
                                        "timelimitaction");
                                dataFromLMSMultiplicityUsed = getMultiplicityUsed(node1,
                                        "datafromlms");
                                masteryScoreMultiplicityUsed = getMultiplicityUsed(node1,
                                        "masteryscore");
                                ...
                                adlitem.setPrerequisitesMultiplicityUsed(prerequisitesMultiplicityUsed);
                                adlitem.setMaxTimeAllowedMultiplicityUsed(maxTimeAllowedMultiplicityUsed);
                                adlitem.setTimeLimitActionMultiplicityUsed(timeLimitActionMultiplicityUsed);
                                adlitem.setDataFromLMSMultiplicityUsed(dataFromLMSMultiplicityUsed);
                                adlitem.setMasteryScoreMultiplicityUsed(masteryScoreMultiplicityUsed);
        ...
        public boolean checkIdentifier()
        {
                ...
                else
                {
                        ...
                        String s3 = "The value, \"" + identifier + "\", of attribute \"" +
                                s + "\" passed the " + "smallest permitted maximum test";
        ...
        public boolean checkIdentifierref(String s)
        {
                ...
                flag = checkMultiplicity(i, s8, s1, l1, i2, identifierref, true) &&
                        flag;
                ...
                if (k2 > j2)
                {
                        ...
                        String s3 = "The smallest permitted maximum for the value of attribute \"" +
                                s1 + "\" is " + j2 + " and a length of " + k2 + " was found.";
                        messageHandler.addMessage(i, k, s3, s8, s9);
                }
                else
                {
                        int l = MessageType.PASSED;
                        String s4 = "The value, \"" + identifierref +
                                "\", of attribute \"" + s1 + "\" passed the " +
                                "smallest permitted maximum test";
                        messageHandler.addMessage(i, l, s4, s8, s9);
                }

                if (identifierref.equalsIgnoreCase("") &&
                        s.equalsIgnoreCase("aggregation"))
                {
                        int i1 = MessageType.PASSED;
                        String s5 = "Attribute \"" + s1 + "\" was not found or was " +
                ...
                else if (idExists)
                {
                        ...
                        String s6 = "Resource identifier \"" + identifierref + "\" has " +
                                "been found";
                ...
                else
                {
                        ...
                        String s7 = "Resource identifier \"" + identifierref + "\" could " +
        ...
        public boolean checkParameters(String s)
        {
                ...
                flag = checkMultiplicity(i, s5, s1, i1, j1, parameterString, true) &&
                        flag;
                ...
                {
                        int l = MessageType.PASSED;
                        String s4 = "The value, \"" + parameterString +
                                "\", of attribute \"" + s1 + "\" passed the " +
                                "smallest permitted maximum test";
        ...
        public boolean checkTitle(String s)
        {
                ...
                {
                        int l = MessageType.PASSED;
                        String s4 = "The value, \"" + title + "\", of element <" + s1 +
        ...
        public boolean checkAdlcpprerequisites(String s)
        {
                ...
                s2 = "Testing element <" + s1 + "> for minimum " + "comformance";
                messageHandler.addMessage(i, j, s2, s5, s6);
                flag = checkMultiplicity(i, s5, s1, i1, j1,
                        prerequisitesMultiplicityUsed) && flag;
                ...
                {
                        int l = MessageType.PASSED;
                        String s4 = "The value, \"" + prerequisites + "\", of element <" +
        ...
        public boolean checkAdlcpmaxtimeallowed(String s)
        {
                ...
                messageHandler.addMessage(i, j, s2, s5, s6);
                flag = checkMultiplicity(i, s5, s1, i1, j1,
                        maxTimeAllowedMultiplicityUsed) && flag;
                ...
                {
                        int l = MessageType.PASSED;
                        String s4 = "The value, \"" + maxTimeAllowed + "\", of element <" +
                                s1 + "> passed the smallest permitted maximum test";
                        messageHandler.addMessage(i, l, s4, s5, s6);
                }
        ...
        public boolean checkAdlcptimelimitaction(String s)
        {
                ...
                flag = checkMultiplicity(i, s6, s1, i1, j1,
                        timeLimitActionMultiplicityUsed) && flag;
                ...
                if (!timeLimitAction.equalsIgnoreCase(""))
                {
                        ...
                        if (!flag1)
                        {
                                ...
                                String s4 = "Element <" + s1 + "> did not adhere to the " +
                                        "restricted vocabulary and failed the vocabulary test";
        ...
        public boolean checkAdlcpdatafromlms(String s)
        {
                ...
                s2 = "Testing element <" + s1 + "> for minimum " + "comformance";
                messageHandler.addMessage(i, j, s2, s5, s6);
                flag = checkMultiplicity(i, s5, s1, i1, j1, dataFromLMSMultiplicityUsed) &&
                        flag;
                ...
                {
                        int l = MessageType.PASSED;
                        String s4 = "The value, \"" + dataFromLMS + "\", of element <" +
                                s1 + "> passed the smallest permitted maximum test";
                        messageHandler.addMessage(i, l, s4, s5, s6);
                }
        ...
        public boolean checkAdlcpmasteryscore(String s)
        {
                ...
                s2 = "Testing element <" + s1 + "> for minimum " + "comformance";
                messageHandler.addMessage(i, j, s2, s5, s6);
                flag = checkMultiplicity(i, s5, s1, i1, j1, masteryScoreMultiplicityUsed) &&
                        flag;
                ...
                {
                        int l = MessageType.PASSED;
                        String s4 = "The value, \"" + masteryScore + "\", of element <" +
                                s1 + "> passed the smallest permitted maximum test";
                        messageHandler.addMessage(i, l, s4, s5, s6);
                }
        ...
        public boolean checkTimespan(String s)
        {
                ...
                if (stringtokenizer.countTokens() == 3)
                {
                        ...
                        if ((s7.length() >= 2) && (s7.length() <= 4) && (s8.length() == 2) &&
                                (s9.length() <= 5))
                        {
                                try
                                {
                                        ...
                                        if ((integer.intValue() >= 0) &&
                                                (integer.intValue() <= 9999) &&
                                                (integer1.intValue() >= 0) &&
                                                (integer1.intValue() <= 99))
                                        {
                                                flag = true;
                                        }
                                        ...
                                        if (s10.length() == 2)
                                        {
                                                ...
                                                {
                                                        System.out.println(
                                                                "seconds part had 2 chars and a valid decimal");
                                                }
                                        }
                                        else
                                        {
                                                ...
                                                {
                                                        System.out.println(
                                                                "Seconds Part did not have 2 chars");
                                                }
                                        }
                                ...
                                catch (NumberFormatException numberformatexception)
                                {
                                        ...
                                        {
                                                System.out.println(
                                                        "Value could not be converted to a time");
                                        }
                ...
                if (!flag)
                {
                        ...
                        String s3 = "The value, \"" + s + "\", of element <" + s1 +
                                ">  did not adhere to the timespan data type format of " +
                                "hhhh:mm:ss.ss and fails the data type format test";
                        messageHandler.addMessage(i, k, s3, s5, s6);
                }
                else
                {
                        int l = MessageType.PASSED;
                        String s4 = "The value, \"" + s + "\", of element <" + s1 +
                                "> passed the data type format test";
                        messageHandler.addMessage(i, l, s4, s5, s6);
                }
