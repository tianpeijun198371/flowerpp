...
import com.ulearning.ulms.scorm.adl.parsers.util.adlrules.manifest.IdentifierRules;
import com.ulearning.ulms.scorm.adl.parsers.util.adlrules.manifest.VersionRules;
...
public class ADLManifest extends ADLElement implements Serializable
{
        ...
        public boolean checkVersion()
        {
                ...
                {
                        int l = MessageType.PASSED;
                        String s3 = "The value, \"" + version + "\", of attribute \"" + s +
        ...
        public String lookupResourceHref(String s)
        {
                ...
                do
                {
                        ...
                        if (s2.equals(s) &&
                                adlresource.getADLCPScormtype().equalsIgnoreCase("sco"))
                        {
