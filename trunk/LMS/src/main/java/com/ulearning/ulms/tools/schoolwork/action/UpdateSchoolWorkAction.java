...
public class UpdateSchoolWorkAction extends UploadAction
{

        public UpdateSchoolWorkAction()
        {
        }
                ...
                throws Exception
        {
                ...
                SchoolWorkHelper.updateSchoolWork(schoolWorkForm);
