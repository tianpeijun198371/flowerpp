...
public class AddCertCourseAction extends Action
{
                ...
                throws Exception
        {
                ...
                String certificateID = request.getParameter("masterID");
                String type = request.getParameter("type");
                String[] courseIDS = request.getParameterValues("masterIDs");
