...
public class RightsRules extends MetadataUtil
{
        ...
        public boolean verifyAssetMandatory()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("cost"))
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "RightsRules::verifyAssetMandatory()",
                                        "Testing element " + elemNum + ".1 <cost>...");
                                setMessage(MessageType.INFO,
                                        "RightsRules::verifyAssetMandatory()",
                                        "Testing element " + elemNum +
                                                ".1 <cost> for multiplicity...");
                                ...
                                if (j > 1)
                                {
                                        setMessage(MessageType.FAILED,
                                                "RightsRules::verifyAssetMandatory()",
                                                "More than 1 <cost> element was found .. 1 and only 1 allowed");
                                        flag = false;
                                }
                                else if (j == 1)
                                {
                                        setMessage(MessageType.PASSED,
                                                "RightsRules::verifyAssetMandatory()",
                                                "1 and only 1 <cost> element was found");
                        ...
                        setMessage(MessageType.OTHER, "", "");
                        setMessage(MessageType.INFO, "RightsRules::verifyAssetMandatory()",
                                "Testing element " + elemNum +
                                        ".2 <copyrightandotherrestrictions>...");
                        setMessage(MessageType.INFO, "RightsRules::verifyAssetMandatory()",
                                "Testing element " + elemNum +
                                        ".2 <copyrightandotherrestrictions> for " + "multiplicity...");
                        ...
                        if (k > 1)
                        {
                                setMessage(MessageType.FAILED,
                                        "RightsRules::verifyAssetMandatory()",
                                        "More than 1 <copyrightandotherrestrictions> element was found .. 1 and only 1 allowed");
                                flag1 = false;
                        }
                        else if (k == 1)
                        {
                                setMessage(MessageType.PASSED,
                                        "RightsRules::verifyAssetMandatory()",
                                        "1 and only 1 <copyrightandotherrestrictions> element was found");
                ...
                {
                        setMessage(MessageType.INFO, "RightsRules::verifyAssetMandatory()",
                                "Testing element " + elemNum + ".1 <cost> for " +
                                        "multiplicity...");
                        setMessage(MessageType.FAILED,
                                "RightsRules::verifyAssetMandatory()",
                                "Element " + elemNum + ".1 <cost> was not found and " +
                ...
                if (!flag3)
                {
                        ...
                        setMessage(MessageType.FAILED,
                                "RightsRules::verifyAssetMandatory()",
                                "Element " + elemNum +
                                        ".2 <copyrightandotherrestrictions> was not found and " +
                                        "must appear 1 and only 1 time");
                }
        ...
        public boolean verifyAssetOptional()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (!flag1)
                        {
                                setMessage(MessageType.OTHER, "", "");
                                setMessage(MessageType.INFO,
                                        "RightsRules::verifyAssetOptional()",
        ...
        private boolean verifyCopyrightandotherrestrictions(Node node)
        {
                ...
                flag = verifyVocabulary(node, vector, "copyrightandotherrestrictions",
                        flag1);
