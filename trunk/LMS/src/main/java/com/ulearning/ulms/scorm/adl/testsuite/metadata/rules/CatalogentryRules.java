        ...
        public boolean verifyAssetMandatory()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("catalog"))
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "CatalogentryRules::verifyAssetMandatory()",
                                        "Testing element " + elemNum + ".1 <catalog>...");
                                setMessage(MessageType.INFO,
                                        "CatalogentryRules::verifyAssetMandatory()",
                                        "Testing element " + elemNum +
                                                ".1 <catalog> for multiplicity...");
                                ...
                                if (j > 1)
                                {
                                        setMessage(MessageType.FAILED,
                                                "CatalogentryRules::verifyAssetMandatory()",
                                                "More than 1 <catalog> element was found .. 1 and only 1 allowed");
                                        flag = false;
                                }
                                else if (j == 1)
                                {
                                        setMessage(MessageType.PASSED,
                                                "CatalogentyRules::verifyAssetMandatory()",
                                                "1 and only 1 <catalog> element was found");
                        ...
                        setMessage(MessageType.INFO,
                                "CatalogentryRules::verifyAssetMandatory()",
                                "Testing element " + elemNum + ".2 <entry>...");
                        setMessage(MessageType.INFO,
                                "CatalogentryRules::verifyAssetMandatory()",
                                "Testing element " + elemNum +
                        ...
                        if (k > 1)
                        {
                                setMessage(MessageType.FAILED,
                                        "CatalogentryRules::verifyAssetMandatory()",
                                        "More than 1 <entry> element was found .. 1 and only 1 allowed");
                                flag1 = false;
                        }
                        else if (k == 1)
                        {
                                setMessage(MessageType.PASSED,
                                        "CatalogentyRules::verifyAssetMandatory()",
                                        "1 and only 1 <entry> element was found");
                ...
                if (!flag2)
                {
                        ...
                        setMessage(MessageType.FAILED,
                                ...
                                "Element " + elemNum + ".1 <catalog> was not found and " +
                ...
                if (!flag3)
                {
                        ...
                        setMessage(MessageType.FAILED,
                                "GeneralRules::verifyAssetMandatory()",
                                "Element " + elemNum + ".2 <entry> was not found and " +
                                        "must appear 1 and only 1 time");
                }
        ...
        public boolean verifyAssetOptional()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("catalog"))
                        {
                                ...
                                setMessage(MessageType.OTHER, "", "");
                                setMessage(MessageType.INFO,
                                        "CatalogentryRules::verifyAssetOptional()",
                                        "Testing element " + elemNum + ".1 <catalog>...");
                                ...
                                setMessage(MessageType.PASSED,
                                        "CatalogentyRules::verifyAssetOptional()",
                                        "1 and only 1 <catalog> element was found");
        ...
        private boolean verifyCatalog(Node node, String s)
        {
                ...
                if (nodelist != null)
                {
                        ...
                        if (i == 0)
                        {
                                flag = false;
                                setMessage(MessageType.FAILED,
                                        "CatalogentryRules::verifyCatalog()",
                                        "No data was found in element <catalog> and fails the minimum character length test");
                        }
                        else if (i == 1)
                        {
                                for (int k = 0; k < nodelist.getLength(); k++)
                                {
                                                ...
                                                (node3.getNodeType() == 4))
                                        {
                                                ...
                                                else
                                                {
                                                        setMessage(MessageType.PASSED,
                                                                "CatalogentryRules::verifyCatalog()",
                                                                "Character length for element  <catalog> has been verified");
                                                }
                                        }
                                }
                        }
                        else
                        {
                                ...
                                setMessage(MessageType.FAILED,
                                        "CatalogentryRules::verifyCatalog()",
                                        "Too many text strings were found in <catalog> and fails the test");
                        }
                }
