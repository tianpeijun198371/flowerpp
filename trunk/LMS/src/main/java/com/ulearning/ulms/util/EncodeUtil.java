...
{
        static final String a[] = {"%00", "%01", "%02", "%03", "%04", "%05",
        ...
        /**
         * convert the gb2312 string passed in to the unicode CharSet
         *
         * @param str string needs Converting
         * @return the string have been converted,null will be returned if parameter
         *         str is null
         */
        public static String GBEncode(String str)
        {
                ...
                else
                {
                        try
                        {
                                ...
                                {
                                        tmp = Integer.toHexString(bytes[k]);
                                        tests = tests + "%" + tmp.substring(tmp.length() - 2);
                                }
                                StrReturned = tests;
                        }
                        catch (Exception e)
        ...
        public static String UTFEncode(String s)
        {
                ...
                for (int j = 0; j < i; j++)
                {
                        ...
                        {
                                stringbuffer.append(a[0xe0 | k >> 12]);
