...
public class SelectCourseTreeBuilder implements UlmsTreeBuilder
{
        private String domain = "Select";
                ...
                try
                {
                        ...
                        for (int i = 0; i < courseList.size(); i++)
                        {
                                        ...
                                        SecurityConstants.USER_COURSE_RELATION))
                                {
                                        ...
                                        String matchName = MatchHelper.getMatchModel(cm.getCourseID())
                                                .getName();
                                        String matchNameGet = "";

                                        if ((matchName != null) && !matchName.equals(""))
                                        {
                                                matchNameGet = "(" + matchName + ")";
                                        }

                                        TreeControlNode subtree = new TreeControlNode("courseID/" +
                                                cm.getCourseID(),
                                                httpServletRequest.getContextPath() +
                                                        "/images/course.gif", cm.getName() + matchNameGet,
                                                httpServletRequest.getContextPath() +
                                                        "/mystudy/course/viewCourse.jsp?courseID=" +
                                                        cm.getCourseID() + "&isNeedApply=true", null,
                                                false, domain);
                                        root.addChild(subtree);
                                }
                        }
                        ...
                        for (int i = 0; i < certList.size(); i++)
                        {
                                        ...
                                        SecurityConstants.USER_CERTIFICATE_RELATION))
                                {
                                        ...
                                        String matchName = MatchHelper.getMatchModel(cf.getCertificateID())
                                                .getName();
                                        String matchNameGet = "";
