/**
 * AddCertUserAction.java.
 * User: dengj  Date: 2004-5-31
 *
...
public class AddCertUserAction extends Action
{
                ...
                throws Exception
        {
                ...
                for (int i = 0; i < roleID.length; i++)
                {
                        ...
                        urf.setRelationID(Integer.parseInt(relationID));
                        urf.setType(Integer.parseInt(type));
                        dao.addUserRole(urf);
                }
