...
public class CourseTreeBuilder implements UlmsTreeBuilder
{
        private String domain = "Master";
        private int type = SecurityConstants.USER_COURSE_RELATION;
        private int catalogType = CourseKeys.CATALOG_MASTER_COURSE;
                              ...
                              HttpServletRequest httpServletRequest)
        {
                ...
                //For the master course need all the people see
                orgID = 0;
