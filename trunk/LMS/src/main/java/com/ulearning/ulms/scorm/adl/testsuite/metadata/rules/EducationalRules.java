...
public class EducationalRules extends MetadataUtil
{
        ...
        public boolean verifyAssetMandatory()
        {
                ...
                {
                        System.out.println("element " + elemNum + " <educational> has no " +
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("interactivitytype"))
                        {
                                if (!flag11)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".1 <interactivitytype>...");
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".1 <interactivitytype> for multiplicity...");
                                        ...
                                        if (j > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "More than 1 <interactivitytype> element was found...0 or 1 allowed");
                                                flag = false;
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "0 or 1 <interactivitytype> element was found");
                        ...
                        if (s.equalsIgnoreCase("learningresourcetype"))
                        {
                                if (!flag12)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".2 <learningresourcetype> for multiplicity...");
                                        ...
                                        if (k > 10)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "More than 10 <learningresourcetype> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "10 or less <learningresourcetype> elements were found");
                                        }
                        ...
                        if (s.equalsIgnoreCase("interactivitylevel"))
                        {
                                if (!flag13)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".3 <interactivitylevel>...");
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".3 <interactivitylevel> for multiplicity...");
                                        ...
                                        if (l > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "More than 1 <interactivitylevel> element was found...0 or 1 allowed");
                                                flag2 = false;
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "0 or 1 <interactivitylevel> element was found");
                        ...
                        if (s.equalsIgnoreCase("semanticdensity"))
                        {
                                if (!flag14)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".4 <semanticdensity> for multiplicity...");
                                        ...
                                        if (i1 > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "More than 1 <semanticdensity> element was found...0 or 1 allowed");
                                                flag3 = false;
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "0 or 1 <semanticdensity> element was found");
                        ...
                        if (s.equalsIgnoreCase("intendedenduserrole"))
                        {
                                if (!flag15)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".5 <intendedenduserrole>...");
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".5 <intendedenduserrole> for multiplicity...");
                                        ...
                                        if (j1 > 10)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "More than 10 <intendedenduserrole> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "10 or less <intendedenduserrole> elements were found");
                                        }
                        ...
                        if (s.equalsIgnoreCase("context"))
                        {
                                if (!flag16)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".6 <context>...");
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".6 <context> for multiplicity...");
                                        ...
                                        if (k1 > 10)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "More than 10 <context> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "10 or less <context> elements were found");
                                        }
                        ...
                        if (s.equalsIgnoreCase("typicalagerange"))
                        {
                                if (!flag17)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".7 <typicalagerange> for multiplicity...");
                                        ...
                                        if (l1 > 5)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "More than 5 <typicalagerange> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "5 or less <typicalagerange> elements were found");
                                        }
                        ...
                        if (s.equalsIgnoreCase("difficulty"))
                        {
                                if (!flag18)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".8 <difficulty>...");
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".8 <difficulty> for multiplicity...");
                                        ...
                                        if (i2 > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "More than 1 <difficulty> element was found...0 or 1 allowed");
                                                flag7 = false;
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "0 or 1 <difficulty> element was found");
                        ...
                        if (s.equalsIgnoreCase("typicallearningtime"))
                        {
                                if (!flag19)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".9 <typicallearningtime>...");
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".9 <typicallearningtime> for multiplicity...");
                                        ...
                                        if (j2 > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "More than 1 <typicallearningtime> element was found...0 or 1 allowed");
                                                flag8 = false;
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "0 or 1 <typicallearningtime> element was found");
                        ...
                        if (s.equalsIgnoreCase("description"))
                        {
                                if (!flag20)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".10 <description>...");
                                        setMessage(MessageType.INFO,
                                                "EducationalRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".10 <description> for multiplicity...");
                                        ...
                                        if (k2 > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "More than 1 <description> element was found...0 or 1 allowed");
                                                flag9 = false;
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "EducationalRules::verifyAssetOptional()",
                                                        "0 or 1 <description> element was found");
                        ...
                        if (!flag21)
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "EducationalRules::verifyAssetOptional()",
                                        "Testing element " + elemNum + ".11 <language>...");
                                setMessage(MessageType.INFO,
                                        "EducationalRules::verifyAssetOptional()",
                                        "Testing element " + elemNum +
                                                ".11 <language> for multiplicity...");
        ...
        private boolean verifyTypicallearningtime(Node node, String s)
        {
                ...
                boolean flag7 = false;
                setMessage(MessageType.INFO,
                        "EducationalRules::verifyTypicallearningtime()",
                        "Testing element " + s + " <typicallearningtime> for " +
                                "Element <datetime>...");
                ...
                if (!flag6)
                {
                        setMessage(MessageType.INFO, "EducationalRules::verifyRole()",
                                "Testing element <datetime> for multiplicity...");
                        setMessage(MessageType.FAILED, "EducationalRules::verifyRole()",
        ...
        private boolean verifyLanguage(Node node, String s)
        {
                ...
                if (nodelist != null)
                {
                        ...
                        if (i == 0)
                        {
                                flag = false;
                                setMessage(MessageType.FAILED,
                                        "EducationalRules::verifyLanguage()",
                        ...
                        else if (i == 1)
                        {
                                for (int k = 0; k < nodelist.getLength(); k++)
                                {
                                                ...
                                                (node3.getNodeType() == 4))
                                        {
                                                ...
                                                {
                                                        setMessage(MessageType.PASSED,
                                                                "EducationalRules::verifyverifyLanguage()",
