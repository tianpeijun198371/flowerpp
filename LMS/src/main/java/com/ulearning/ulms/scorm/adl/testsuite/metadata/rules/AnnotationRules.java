...
public class AnnotationRules extends MetadataUtil
{
        ...
        public boolean verifyAssetMandatory()
        {
                if (com.ulearning.ulms.scorm.adl.util.debug.DebugIndicator.ON)
                {
                        System.out.println("Element " + elemNum + " <annotation> has no " +
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("person"))
                        {
                                if (!flag3)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                ...
                                                "Testing element " + elemNum + ".1 <person>...");
                                        setMessage(MessageType.INFO,
                                                "AnnotationRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".1 <person> for multiplicity...");
                                        ...
                                        if (j > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "AnnotationRules::verifyAssetOptional()",
                                                        "More than 1 <person> element was found .. 0 or 1 allowed");
                                                flag = false;
                                        }
                                        else if (j == 1)
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "AnnotationRules::verifyAssetOptional()",
                                                        "0 or 1 <person> element was found");
                        ...
                        if (s.equalsIgnoreCase("date"))
                        {
                                if (!flag4)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "AnnotationRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".2 <date>...");
                                        setMessage(MessageType.INFO,
                                                "AnnotationRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".2 <date> for multiplicity...");
        ...
        private boolean verifyPerson(Node node, String s)
        {
                ...
                if (nodelist != null)
                {
                        ...
                        if (!flag1)
                        {
                                ...
                                setMessage(MessageType.FAILED,
                                        "AnnotationRules::verifyPerson()",
                                        "No vcard element was found in element " + s + " <person>");
                        }
                }
        ...
        private boolean verifyDate(Node node, String s)
        {
                ...
                boolean flag2 = false;
                boolean flag3 = false;
                setMessage(MessageType.INFO, "AnnotationRules::verifyDate()",
                        "Testing element " + s + " <date> for " + "Element <datetime>...");
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (!flag3)
                        {
                                ...
                                setMessage(MessageType.PASSED, "AnnotationRules::verifyDate()",
                ...
                if (!flag2)
                {
                        setMessage(MessageType.INFO, "AnnotationRules::verifyRole()",
                                "Testing element <datetime> for multiplicity...");
                        setMessage(MessageType.FAILED, "AnnotationRules::verifyRole()",
