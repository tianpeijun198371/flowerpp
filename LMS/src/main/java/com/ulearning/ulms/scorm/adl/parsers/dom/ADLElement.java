...
public class ADLElement
{
                ...
                if (nodelist != null)
                {
                        for (int i = 0; i < nodelist.getLength(); i++)
                        {
                                if ((nodelist.item(i).getNodeType() == 1) &&
                                        nodelist.item(i).getLocalName().equalsIgnoreCase(s))
                                {
        ...
        public boolean checkMultiplicity(int i, String s)
        {
                ...
                else if (min == max)
                {
                        ...
                        s1 = "The multiplicity for element <" + elemName + "> is " + min +
                                " and only " + max + " and " + multiplicity + " were found.";
                }
                else if (spm > 0)
                {
                        j = MessageType.WARNING;
                        s1 = "The smallest permitted maximum for element <" + elemName +
                                "> is " + spm + " and " + multiplicity + " were found.";
                        flag = true;
                }
                else
                {
                        j = MessageType.FAILED;
                        s1 = "The multiplicity for element <" + elemName + "> is " + min +
                                " or " + max + " and " + multiplicity + " were found.";
                }
        ...
        public boolean checkMultiplicity(int i, String s, String s1, int j, int k,
                                         int l)
        {
                boolean flag = false;
                int i1 = -1;
                ...
                if ((l >= j) && (l <= k))
                {
                        i1 = MessageType.PASSED;
                        s2 = "Element <" + s1 + "> passed the multiplicity test";
                        flag = true;
                }
                else if (j == k)
                {
                        i1 = MessageType.FAILED;
                        s2 = "The multiplicity for element <" + s1 + "> is " + j +
                                " and only " + k + " and " + l + " were found.";
                }
                else
                {
                        i1 = MessageType.FAILED;
                        s2 = "The multiplicity for element <" + s1 + "> is " + j + " or " +
                                k + " and " + l + " were found.";
                }

                messageHandler.addMessage(i, i1, s2, s, s3);
                                         ...
                                         String s2, boolean flag)
        {
                ...
                if (j > 0)
                {
                        if (s2.equalsIgnoreCase(""))
                        {
                                ...
                                if (flag)
                                {
                                        s4 = "Attribute \"" + s1 + "\" was not found or was " +
                                                "left blank.";
                                }
                                else
                                {
                                        s4 = "Element <" + s1 + "> was not found or was " +
                                                "left blank.";
                                }
                                ...
                                if (j == k)
                                {
                                        ...
                                        if (flag)
                                        {
                                                s4 = "The multiplicity for attribute \"" + s1 + "\"" +
                                                        " is " + j + " and only " + k;
                                        }
                                        else
                                        {
                                                s4 = "The multiplicity for element <" + s1 + ">" +
                                                        " is " + j + " and only " + k;
                                        }
                                }
                                else
