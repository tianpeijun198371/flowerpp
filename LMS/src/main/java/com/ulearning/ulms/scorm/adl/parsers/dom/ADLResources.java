...
import com.ulearning.ulms.scorm.adl.parsers.util.adlrules.manifest.ResourcesRules;
...
public class ADLResources extends ADLElement implements Serializable
{
        ...
        public boolean fillResources(Node node)
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if ((node1.getNodeType() == 1) &&
                                node1.getLocalName().equalsIgnoreCase("resource"))
                        {
        ...
        public boolean checkConformance(String s, String s1)
        {
                ...
                for (int l = 0; l < k; l++)
                {
                        flag = ((ADLResource) resourceList.elementAt(l)).checkConformance(s,
                                s5) && flag;
                        messageHandler.appendMessage(i,
                                ((ADLResource) resourceList.elementAt(l)).getMessage(i));
                }
        ...
        public boolean setIdExists(Vector vector)
        {
                ...
                for (int j = 0; j < i; j++)
                {
                        flag = ((ADLResource) resourceList.elementAt(j)).setIdExists(vector) &&
                                flag;
                }
