...
public class CMICore extends CMICategory implements Serializable
{
        ...
        public CMICore()
        {
                ...
                super(true);
                student_id = new Element("", "checkIdentifier", "NULL", false, true,
                        true);
                student_name = new Element("", "checkString255", "NULL", false, true,
                        true);
                lesson_location = new Element("", "checkString255", "NULL", true, true,
                        true);
                credit = new Element("", "checkVocabulary", "Credit", false, true, true);
                lesson_status = new Element("", "checkVocabulary", "Status", true,
                        true, true);
                entry = new Element("", "checkVocabulary", "Entry", false, true, true);
                total_time = new Element("", "checkTimespan", "NULL", false, true, true);
                lesson_mode = new Element("", "checkVocabulary", "Mode", false, true,
                        true);
                exit = new Element("", "checkVocabulary", "Exit", true, false, true);
                session_time = new Element("", "checkTimespan", "NULL", true, false,
                        true);
                score = new CMIScore();
        }
         ...
         * *************************************************************************
         */
        private String processSubcategory(CMIRequest theRequest, String theElement,
        ...
        public void showData()
        {
                if (true)
                {
                        ...
                        System.out.println("\tstudent_name: " +
                                getStudentName().getValue());
                        System.out.println("\tlesson_location: " +
                                getLessonLocation().getValue());
                        System.out.println("\tcredit: " + getCredit().getValue());
                        System.out.println("\tslesson_status: " +
                                getLessonStatus().getValue());
                        ...
                        System.out.println("\tscore.min: " +
                                getScore().getMin().getValue());
                        System.out.println("\tscore.max: " +
                                getScore().getMax().getValue());
                        System.out.println("\tsession_time: " +
                                getSessionTime().getValue());
