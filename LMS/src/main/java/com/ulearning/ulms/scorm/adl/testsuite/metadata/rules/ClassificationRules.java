...
public class ClassificationRules extends MetadataUtil
{
        ...
        public boolean verifyAssetMandatory()
        {
                if (DebugIndicator.ON)
                {
                        System.out.println("element " + elemNum +
                                " <classification> has no " + "mandatory sub-elements");
                }
        ...
        public boolean verifyScoMandatory()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("purpose"))
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "ClassificationRules::verifyScoMandatory()",
                                        "Testing element " + elemNum + ".1 <purpose>...");
                                setMessage(MessageType.INFO,
                                        "ClassificationRules::verifyScoMandatory()",
                                        "Testing element " + elemNum +
                                                ".1 <purpose> for multiplicity...");
                                ...
                                if (j > 1)
                                {
                                        setMessage(MessageType.FAILED,
                                                "AnnotationRules::verifyScoMandatory()",
                                                "More than 1 <purpose> element was found .. 0 or 1 allowed");
                                        flag = false;
                                }
                                else if (j == 1)
                                {
                                        setMessage(MessageType.PASSED,
                                                "ClassificationRules::verifyScoMandatory()",
                                                "0 or 1 <purpose> element was found");
                        ...
                        if (s.equalsIgnoreCase("description"))
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "ClassificationRules::verifyScoMandatory()",
                                        "Testing element " + elemNum + ".3 <description>...");
                                setMessage(MessageType.INFO,
                                        "ClassificationRules::verifyScoMandatory()",
                                        "Testing element " + elemNum +
                                                ".3 <description> for multiplicity...");
                        ...
                        if (!flag5)
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "ClassificationRules::verifyScoMandatory()",
                                        "Testing element " + elemNum + ".4 <keyword>...");
                                setMessage(MessageType.INFO,
                                        "ClassificationRules::verifyScoMandatory()",
                                        "Testing element element " + elemNum +
                                                ".4 <keyword> for multiplicity...");
                                ...
                                if (l > 40)
                                {
                                        setMessage(MessageType.WARNING,
                                                "ClassificationRules::verifyScoMandatory()",
                                                "More than 40 <keyword> elements were found");
                                }
                                else
                                {
                                        setMessage(MessageType.PASSED,
                                                "ClassificationRules::verifyScoMandatory()",
                                                "40 or less <keyword> elements were found");
                                }
                ...
                if (!flag3)
                {
                        ...
                        setMessage(MessageType.FAILED,
                                "ClassificationRules::verifyScoMandatory()",
                                "Element " + elemNum + ".1 <purpose> was not found and " +
                ...
                if (!flag4)
                {
                        ...
                        setMessage(MessageType.FAILED,
                                "ClassificationRules::verifyScoMandatory()",
                                "Element " + elemNum + ".3 <description> was not found and " +
                                        "must appear 1 and only 1 time");
                }
                ...
                if (!flag5)
                {
                        setMessage(MessageType.INFO,
                                "ClassificationRules::verifyScoMandatory()",
                                "Testing element " + elemNum + ".4 <keyword> for " +
                                        "multiplicity...");
                        setMessage(MessageType.FAILED,
                                "ClassificationRules::verifyScoMandatory()",
                                "Element " + elemNum + ".4 <keyword> was not found and " +
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("purpose"))
                        {
                                if (!flag4)
                                {
                                        setMessage(MessageType.OTHER, "", "");
                                        setMessage(MessageType.INFO,
                                                "ClassificationRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".1 <purpose>...");
                                        setMessage(MessageType.INFO,
                                                "ClassificationRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                        ...
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "AnnotationRules::verifyAssetOptional()",
                                                        "More than 1 <purpose> element was found .. 0 or 1 allowed");
                                                flag = false;
                                        }
                                        else if (j == 1)
                        ...
                        if (s.equalsIgnoreCase("taxonpath"))
                        {
                                if (!flag5)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "ClassificationRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".2 <taxonpath>...");
                                        setMessage(MessageType.INFO,
                                                "ClassificationRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".2 <taxonpath> for multiplicity...");
                                        ...
                                        if (k > 15)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "ClassificationRules::verifyAssetOptional()",
                                                        "More than 15 <taxonpath> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "ClassificationRules::verifyAssetOptional()",
                                                        "15 or less <taxonpath> elements were found");
                                        }

                                        flag5 = true;
                                }

                                TaxonpathRules taxonpathrules = new TaxonpathRules(node1,
                                        elemNum + ".2");
        ...
        public boolean verifyScoOptional()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (!flag1)
                        {
                                setMessage(MessageType.OTHER, "", "");
                                setMessage(MessageType.INFO,
                                        "ClassificationRules::verifyScoOptional()",
                                        "Testing element " + elemNum + ".2 <taxonpath>...");
                                setMessage(MessageType.INFO,
                                        "ClassificationRules::verifyScoOptional()",
                                        "Testing element " + elemNum +
