...
public class RelationRules extends MetadataUtil
{
        ...
        public boolean verifyAssetMandatory()
        {
                if (com.ulearning.ulms.scorm.adl.util.debug.DebugIndicator.ON)
                {
                        System.out.println("element " + elemNum + " (relation) has no " +
        ...
        public boolean verifyAssetOptional()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("kind"))
                        {
                                if (!flag2)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "RelationRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".1 <kind>...");
                                        setMessage(MessageType.INFO,
                                                "RelationRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".1 <kind> for multiplicity...");
                                        ...
                                        if (j > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "RelationRules::verifyAssetOptional()",
                                                        "More than 1 <kind> element was found .. 0 or 1 allowed");
                                                flag = false;
                                        }
                                        else if (j == 1)
                                        {
                        ...
                        if (!flag3)
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "RelationRules::verifyAssetOptional()",
                                        "Testing element " + elemNum + ".2 <resource>...");
                                setMessage(MessageType.INFO,
                                        "RelationRules::verifyAssetOptional()",
                                        "Testing element " + elemNum +
                                                ".2 <resource> for multiplicity...");
                                ...
                                if (k > 1)
                                {
                                        setMessage(MessageType.FAILED,
                                                "RelationRules::verifyAssetOptional()",
                                                "More than 1 <resource> element was found .. 0 or 1 allowed");
                                        flag1 = false;
                                }
                                else if (k == 1)
                                {
                                        setMessage(MessageType.PASSED,
                                                "RelationRules::verifyAssetOptional()",
                                                "0 or 1 <resource> element was found");
        ...
        public boolean verifyResource(Node node, String s)
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s1.equalsIgnoreCase("description"))
                        {
                                ...
                                setMessage(MessageType.OTHER, "", "");
                                setMessage(MessageType.INFO, "RelationRules::verifyResource()",
                                        "Testing element " + s + ".2 <description>...");
                                setMessage(MessageType.INFO, "RelationRules::verifyResource()",
                                        "Testing element " + s +
                                                ".2 <description> for multiplicity...");
                        ...
                        if (s1.equalsIgnoreCase("identifier"))
                        {
                                flag5 = false;
                                setMessage(MessageType.INFO, "RelationRules::verifyResource()",
                                        "Testing element 7.2 <resource> for reserved element <identifier>..");
                                setMessage(MessageType.FAILED,
                                        "RelationRules::verifyResource()",
                                        "Element 7.2.1 <identifier> was found and is a Reserved element");
                        ...
                        if (!flag6)
                        {
                                setMessage(MessageType.OTHER, "", "");
                                setMessage(MessageType.INFO, "RelationRules::verifyResource()",
                                        "Testing element " + s + ".3 <catalogentry>...");
                                setMessage(MessageType.INFO, "RelationRules::verifyResource()",
                                        "Testing element " + s +
                        ...
                        CatalogentryRules catalogentryrules = new CatalogentryRules(node2,
                                s + ".3");
