 ...
 **
 ** Module/Package Name: com.ulearning.ulms.scorm.datamodel.cmi
 ...
 **
 *******************************************************************************/
package com.ulearning.ulms.scorm.datamodels.cmi;
...
public class CMIInteractionData extends CMICategory implements Serializable
{
        ...
        public CMIInteractionData()
        {
                ...
                type = new Element("", "checkVocabulary", "Interaction", true, false,
                        false);
                weighting = new Element("", "checkDecimal", "NULL", true, false, false);
                student_response = new Element("", "checkFeedback", "NULL", true,
                        false, false);
         ...
         * *************************************************************************
         */
        private void performSetForObjID(String token, CMIRequest theRequest,
                                        DMErrorManager dmErrorMgr)
        {
                ...
                try
                {
                        ...
                        boolean result = validateType(this, tmpElement, "id", value,
                                dmErrorMgr);
                ...
                catch (ArrayIndexOutOfBoundsException e)
                {
                        ...
                        if (arrayIndex <= objectives.size())
                        {
                                ...
                                Element tmpElement = new Element(theRequest.getValue(),
                                        "checkIdentifier", "NULL", true, false, false);

                                // before setting the type make sure the type is valid
                                boolean result = validateType(this, tmpElement, "id",
                                        theRequest.getValue(), dmErrorMgr);
         ...
         * *************************************************************************
         */
        private void performSetForResponse(String token, CMIRequest theRequest,
                                           DMErrorManager dmErrorMgr)
        {
                if (true)
                {
                        System.out.println(
                                "\t\tCMIInteractionData::performSetForResponses()");
                }
                ...
                try
                {
                        ...
                        if (true)
                        {
                                System.out.println("\t\tElement already exists");
                                System.out.println(
                                        "\t\tSet the value in the element and replace");
                                System.out.println("\t\tVector size: " +
                                        correct_responses.size());
                        }
         ...
         * *************************************************************************
         */
        private int getArrayIndex(String token, CMIRequest theRequest,
                                  DMErrorManager dmErrorMgr)
        {
                int index = -1;
                ...
                catch (NumberFormatException nfe)
                {
                        if (true)
                        {
                                ...
                                System.out.println("\t\tInvalid element " + token +
        ...
        public String getCount(CMIRequest theRequest, DMErrorManager dmErrorMgr)
        {
                ...
                else if (token.equals("correct_responses"))
                {
                        ...
                        {
                                System.out.println(
                                        "\t\tInteractionData:correct_responses._count");
                        }
                ...
                {
                        System.out.println(
                                "\t\tReturning from getCount() count returning: " + result);
                }
