...
import com.ulearning.ulms.scorm.adl.parsers.util.adlrules.manifest.DefaultRules;
import com.ulearning.ulms.scorm.adl.parsers.util.adlrules.manifest.OrganizationsRules;
...
public class ADLOrganizations extends ADLElement implements Serializable
{
        ...
        public boolean fillOrgs(Node node, Vector vector)
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if ((node1.getNodeType() == 1) &&
                                node1.getLocalName().equalsIgnoreCase("organization"))
                        {
        ...
        public boolean checkConformance(String s, String s1)
        {
                ...
                else if (s.equalsIgnoreCase("resource") && (i > 0))
                {
                ...
                else
                {
                        ...
                        {
                                flag = ((ADLOrganization) organizationList.elementAt(j1)).checkConformance(s,
                                        s1) && flag;
                                messageHandler.appendMessage(j,
                                        ((ADLOrganization) organizationList.elementAt(j1)).getMessage(
                                                j));
                        }
                }
        ...
        public boolean checkDefault(String s)
        {
                ...
                if (s.equalsIgnoreCase("aggregation") && !defaultAttr.equals(""))
                {
                        ...
                        if (flag1)
                        {
                                ...
                                String s3 = "Organization identifier \"" + defaultAttr +
                                        "\" has " + "been found";
                        ...
                        {
                                int i1 = MessageType.FAILED;
                                String s4 = "Organization identifier \"" + defaultAttr +
                                        "\" could " +
                ...
                else if (s.equalsIgnoreCase("aggregation") && (i2 > 1))
                {
