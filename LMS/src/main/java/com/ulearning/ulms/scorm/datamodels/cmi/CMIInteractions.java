...
public class CMIInteractions extends CMICategory implements Serializable
{
        ...
        {
                String children = "id,objectives,time,type,correct_responses,weighting," +
                        ...
                        catch (NumberFormatException nfe)
                        {
                                if (true)
                                {
                                        ...
                                        System.out.println("\tInvalid data model element: " +
                                                theRequest.getRequest() + " passed to LMSSetValue()");
                                }
                        ...
                        else
                        {
                                ...
                                catch (NumberFormatException nfe)
                                {
                                        if (true)
                                        {
                                                ...
                                                System.out.println(
                                                        "\tError - Invalid LMSGetValue() request");
                                        }
