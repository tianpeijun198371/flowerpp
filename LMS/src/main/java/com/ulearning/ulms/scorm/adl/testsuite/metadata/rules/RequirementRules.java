...
public class RequirementRules extends MetadataUtil
{
        ...
        public boolean verifyAssetMandatory()
        {
                if (DebugIndicator.ON)
                {
                        System.out.println("element " + elemNum + " (requirement) has no " +
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("type"))
                        {
                                if (!flag4)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "RequirementRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".1 <type>...");
                                        setMessage(MessageType.INFO,
                                                "RequirementRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".1 <type> for " +
                                                        "multiplicity...");
                                        ...
                                        if (j > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "RequirementRules::verifyAssetOptional()",
                                                        "More than 1 <type> element was found...0 or 1 allowed");
                                                flag = false;
                                        }
                                        else
                                        {
                        ...
                        if (s.equalsIgnoreCase("name"))
                        {
                                if (!flag5)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "RequirementRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".2 <name>...");
                                        setMessage(MessageType.INFO,
                                                "RequirementRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".2 <name> for " +
                                                        "multiplicity...");
                                        ...
                                        if (k > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "RequirementRules::verifyAssetOptional()",
                                                        "More than 1 <name> element was found...0 or 1 allowed");
                                                flag1 = false;
                                        }
                                        else
                                        {
                        ...
                        if (s.equalsIgnoreCase("minimumversion"))
                        {
                                if (!flag6)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "RequirementRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".3 <minimumversion> for multiplicity...");
                                        ...
                                        if (l > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "RequirementRules::verifyAssetOptional()",
                                                        "More than 1 <minimumversion> element was found...0 or 1 allowed");
                                                flag2 = false;
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "RequirementRules::verifyAssetOptional()",
                                                        "0 or 1 <minimumversion> element was found");
                        ...
                        if (!flag7)
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "RequirementRules::verifyAssetOptional()",
                                        "Testing element " + elemNum + ".4 <maximumversion>...");
                                setMessage(MessageType.INFO,
                                        "RequirementRules::verifyAssetOptional()",
                                        "Testing element " + elemNum +
                                                ".4 <maximumversion> for multiplicity...");
                                ...
                                if (i1 > 1)
                                {
                                        setMessage(MessageType.FAILED,
                                                "RequirementRules::verifyAssetOptional()",
                                                "More than 1 <maximumversion> element was found...0 or 1 allowed");
                                        flag3 = false;
                                }
                                else
                                {
                                        setMessage(MessageType.PASSED,
                                                "RequirementRules::verifyAssetOptional()",
                                                "0 or 1 <maximumversion> element was found");
        ...
        private boolean verifyName(Node node)
        {
                ...
                else if (s.equalsIgnoreCase("Browser"))
                {
        ...
        private boolean verifyMinimumversion(Node node, String s)
        {
                ...
                if (nodelist != null)
                {
                        ...
                        if (i == 0)
                        {
                                flag = false;
                                setMessage(MessageType.FAILED,
                                        "RequirementRules::verifyMinimumversion()",
                                        "No data was found in element <minimumversion> and fails the minimum character length test");
                        }
                        else if (i == 1)
                        {
                                                ...
                                                (node3.getNodeType() == 4))
                                        {
                                                setMessage(MessageType.INFO,
                                                        ...
                                                        "Testing text of element " + s +
                                                                " <minimumversion> for character length...");
                                                ...
                                                if (s2.length() > byte0)
                                                {
                                                        setMessage(MessageType.WARNING,
                                                                ...
                                                                "The text contained in element " + s +
                                                                        " <minimumversion> is greater than " + byte0);
                                                }
                                                else if (s2.length() < 1)
                                                {
                                                        flag = false;
                                                        setMessage(MessageType.FAILED,
                                                                ...
                                                                "No text was found in element " + s +
                                                                        " <minimumversion> and fails the minimum " +
                                                ...
                                                else
                                                {
                                                        setMessage(MessageType.PASSED,
                                                                ...
                                                                "Character length for element " + s +
                                                                        " <minimumversion> has been verified");
                                                }
                                        }
                                }
                        }
                        else
                        {
                                ...
                                setMessage(MessageType.FAILED,
                                        "RequirementRules::verifyMinimumversion()",
                                        "Too many text strings were found in <minimumversion> and fails the test");
                        }
                }
        ...
        private boolean verifyMaximumversion(Node node, String s)
        {
                ...
                if (nodelist != null)
                {
                        ...
                        if (i == 0)
                        {
                                flag = false;
                                setMessage(MessageType.FAILED,
                                        "RequirementRules::verifyMaximumversion()",
                                        "No data was found in element <maximumversion> and fails the minimum character length test");
                        }
                        else if (i == 1)
                        {
                                for (int k = 0; k < nodelist.getLength(); k++)
                                {
                                                ...
                                                (node3.getNodeType() == 4))
                                        {
                                                setMessage(MessageType.INFO,
                                                        "RequirementRules::verifyMaximumversion()",
                                                        "Testing text of element " + s +
                                                                " <maximumversion> for character length...");
                                                ...
                                                if (s2.length() > byte0)
                                                {
                                                        setMessage(MessageType.WARNING,
                                                                "RequirementRules::verifyMaximumversion()",
                                                                "The text contained in element " + s +
                                                                        " <maximumversion> is greater than " + byte0);
                                                }
                                                else if (s2.length() < 1)
                                                {
                                                        flag = false;
                                                        setMessage(MessageType.FAILED,
                                                                "RequirementRules::verifyMaximumversion()",
                                                                "No text was found in element " + s +
                                                                        " <maximumversion> and fails the minimum " +
                                                                        "character length test");
                                                }
                                                else
                                                {
                                                        setMessage(MessageType.PASSED,
                                                                "RequirementRules::verifyMaximumversion()",
                                                                "Character length for element  <maximumversion> has been verified");
                                                }
                                        }
                                }
                        }
                        else
                        {
                                ...
                                setMessage(MessageType.FAILED,
                                        "RequirementRules::verifyMaximumversion()",
                                        "Too many text strings were found in <maximumversion> and fails the test");
                        }
                }
