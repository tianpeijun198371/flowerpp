...
public class LomRules extends MetadataUtil
{
        ...
        public boolean verifyAssetMandatory()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("metametadata"))
                        {
                                if (!flag4)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetMandatory()",
                                                "Testing element 3 <metametadata>...");
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetMandatory()",
                                                "Testing element 3 <metametadata> for multiplicity...");
                                        setMessage(MessageType.PASSED,
                                                "LomRules::verifyAssetMandatory()",
                                                "Element 3 <metametadata> existed 1 and only 1 time");
                                        flag4 = true;
                                }

                                MetametadataRules metametadatarules = new MetametadataRules(node1,
                                        "3");
                        ...
                        if (s.equalsIgnoreCase("general"))
                        {
                                if (!flag5)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetMandatory()",
                                                "Testing element 1 <general>...");
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetMandatory()",
                                                "Testing element 1 <general> for multiplicity...");
                                        setMessage(MessageType.PASSED,
                                                "LomRules::verifyAssetMandatory()",
                                                "Element 1 <general> existed 1 and only 1 time");
                                        flag5 = true;
                                }
                        ...
                        if (s.equalsIgnoreCase("technical"))
                        {
                                if (!flag6)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetMandatory()",
                                                "Testing element 4 <technical>...");
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetMandatory()",
                                                "Testing element 4 <technical> for multiplicity...");
                                        setMessage(MessageType.PASSED,
                                                "LomRules::verifyAssetMandatory()",
                                                "Element 4 <technical> existed 1 and only 1 time");
                                        flag6 = true;
                                }
                        ...
                        if (!flag7)
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "LomRules::verifyAssetMandatory()",
                                        "Testing element 6 <rights>...");
                                setMessage(MessageType.INFO,
                                        "LomRules::verifyAssetMandatory()",
                                        "Testing element 6 <rights> for multiplicity...");
                                setMessage(MessageType.PASSED,
                                        "LomRules::verifyAssetMandatory()",
                                        "Element 6 <rights> existed 1 and only 1 time");
                                flag7 = true;
                        }
                ...
                if (!flag4)
                {
                        setMessage(MessageType.INFO, "LomRules::verifyAssetMandatory()",
                                "Testing element 3 <metametadata> for multiplicity...");
                        setMessage(MessageType.FAILED, "LomRules::verifyAssetMandatory()",
                                "Element 3 <metametadata> was not found and must appear 1 and only 1 time");
                }
                ...
                if (!flag5)
                {
                        setMessage(MessageType.INFO, "LomRules::verifyAssetMandatory()",
                                "Testing element 1 <general> for multiplicity...");
                        setMessage(MessageType.FAILED, "LomRules::verifyAssetMandatory()",
                                "Element 1 <general> was not found and must appear 1 and only 1 time");
                }
                ...
                if (!flag6)
                {
                        setMessage(MessageType.INFO, "LomRules::verifyAssetMandatory()",
                                "Testing element 4 <technical> for multiplicity...");
                        setMessage(MessageType.FAILED, "LomRules::verifyAssetMandatory()",
                                "Element 4 <technical> was not found and must appear 1 and only 1 time");
                }
                ...
                if (!flag7)
                {
                        setMessage(MessageType.INFO, "LomRules::verifyAssetMandatory()",
                                "Testing element 6 <rights> for multiplicity...");
                        setMessage(MessageType.FAILED, "LomRules::verifyAssetMandatory()",
                                "Element 6 <rights> was not found and must appear 1 and only 1 time");
                }

                if (DebugIndicator.ON)
                {
                        boolean flag8 = flag1 && flag && flag2 && flag3 && flag4 && flag5 &&
                                flag6 && flag7;
                        System.out.println("returning ->" + flag8);
                }

                return flag1 && flag && flag2 && flag3 && flag4 && flag5 && flag6 &&
                        flag7;
        }
        ...
        public boolean verifyScoMandatory()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("lifecycle"))
                        {
                                if (!flag8)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyScoMandatory()",
                                                "Testing element 2 <lifecycle>...");
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyScoMandatory()",
                                                "Testing element 2 <lifecycle> for multiplicity...");
                                        setMessage(MessageType.PASSED,
                                                "LomRules::verifyScoMandatory()",
                                                "Element 2 <lifecycle> existed 1 and only 1 time");
                                        flag8 = true;
                                }
                        ...
                        {
                                setMessage(MessageType.OTHER, "", "");
                                setMessage(MessageType.INFO, "LomRules::verifyScoMandatory()",
                                        "Testing element 9 <classification>...");
                                setMessage(MessageType.INFO, "LomRules::verifyScoMandatory()",
                                        "Testing element 9 <classification> for multiplicity...");
                                ...
                                if (j > 40)
                                {
                                        setMessage(MessageType.WARNING,
                                                "LomRules::verifyScoMandatory()",
                                                "More than 40 <classification> elements were found");
                                        flag11 = true;
                                }
                                else
                                {
                                        setMessage(MessageType.PASSED,
                                                "LomRules::verifyScoMandatory()",
                                                "40 or less <classification> elements were found");
                                        flag11 = true;
                                }
                        }

                        ClassificationRules classificationrules = new ClassificationRules(node1,
                                "9");
                ...
                if (!flag6)
                {
                        setMessage(MessageType.INFO, "LomRules::verifyScoMandatory()",
                                "Testing element 3 <metametadata> for multiplicity...");
                        setMessage(MessageType.FAILED, "LomRules::verifyScoMandatory()",
                                "Element 3 <metametadata> was not found and must appear 1 and only 1 time");
                }
                ...
                if (!flag8)
                {
                        setMessage(MessageType.INFO, "LomRules::verifyScoMandatory()",
                                "Testing element 2 <lifecycle> for multiplicity...");
                        setMessage(MessageType.FAILED, "LomRules::verifyScoMandatory()",
                                "Element 2 <lifecycle> was not found and must appear 1 and only 1 time");
                }
                ...
                if (!flag11)
                {
                        setMessage(MessageType.INFO, "LomRules::verifyScoMandatory()",
                                "Testing element 9 <classification> for multiplicity...");
                        setMessage(MessageType.FAILED, "LomRules::verifyScoMandatory()",
                                "Element 9 <classification> was not found and must appear 1 or more times");
                }

                if (DebugIndicator.ON)
                {
                        boolean flag12 = flag && flag1 && flag2 && flag3 && flag4 && flag5 &&
        ...
        public boolean verifyAssetOptional()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("metametadata"))
                        {
                                ...
                                appendMessages(metametadatarules.getMessages());
                                optionalNotUsed = optionalNotUsed &&
                                        metametadatarules.isOptionalNotUsed();
                        ...
                        if (s.equalsIgnoreCase("general"))
                        {
                                ...
                                appendMessages(generalrules.getMessages());
                                optionalNotUsed = optionalNotUsed &&
                                        generalrules.getOptionalNotUsed();
                        ...
                        if (s.equalsIgnoreCase("technical"))
                        {
                                ...
                                appendMessages(technicalrules.getMessages());
                                optionalNotUsed = optionalNotUsed &&
                                        technicalrules.getOptionalNotUsed();
                        ...
                        if (s.equalsIgnoreCase("educational"))
                        {
                                if (!flag13)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetOptional()",
                                                "Testing element 5 <educational>...");
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetOptional()",
                                                "Testing element 5 <educational> for multiplicity...");
                                        setMessage(MessageType.PASSED,
                                                "LomRules::verifyAssetOptional()",
                                                "Element 5 <educational> existed 1 and only 1 time");
                                        flag13 = true;
                                }

                                EducationalRules educationalrules = new EducationalRules(node1,
                                        "5");
                        ...
                        if (s.equalsIgnoreCase("rights"))
                        {
                                ...
                                appendMessages(rightsrules.getMessages());
                                optionalNotUsed = optionalNotUsed &&
                                        rightsrules.getOptionalNotUsed();
                        ...
                        if (s.equalsIgnoreCase("relation"))
                        {
                                if (!flag15)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetOptional()",
                                                "Testing element 7 <relation>...");
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetOptional()",
                                                "Testing element element 7 <relation> for multiplicity...");
                                        ...
                                        if (j > 100)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "LomRules::verifyAssetOptional()",
                                                        "More than 100 <relation> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "LomRules::verifyAssetOptional()",
                                                        "100 or less <relation> elements were found");
                                        }
                        ...
                        if (s.equalsIgnoreCase("annotation"))
                        {
                                if (!flag16)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetOptional()",
                                                "Testing element 8 <annotation>...");
                                        setMessage(MessageType.INFO,
                                                "LomRules::verifyAssetOptional()",
                                                "Testing element element 8 <annotation> for multiplicity...");
                                        ...
                                        if (k > 30)
                                        {
                                                setMessage(MessageType.WARNING,
                                                        "LomRules::verifyAssetOptional()",
                                                        "More than 30 <annotation> elements were found");
                                        }
                                        else
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "LomRules::verifyAssetOptional()",
                                                        "30 or less <annotation> elements were found");
                                        }
                        ...
                        {
                                setMessage(MessageType.OTHER, "", "");
                                setMessage(MessageType.INFO, "LomRules::verifyAssetOptional()",
                                        "Testing element 9 <classification>...");
                                setMessage(MessageType.INFO, "LomRules::verifyAssetOptional()",
                                        "Testing element 9 <classification> for multiplicity...");
                ...
                if (DebugIndicator.ON)
                {
                        boolean flag18 = flag && flag1 && flag2 && flag3 && flag4 && flag5 &&
                                flag6 && flag7 && flag8;
        ...
        public boolean verifyScoOptional()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("lifecycle"))
                        {
                                ...
                                appendMessages(lifecyclerules.getMessages());
                                optionalNotUsed = optionalNotUsed &&
                                        lifecyclerules.getOptionalNotUsed();
                        ...
                        {
                                setMessage(MessageType.OTHER, "", "");
                                setMessage(MessageType.INFO, "LomRules::verifyScoOptional()",
                                        "Testing element 9 <classification>...");
                                flag17 = true;
                        }
                        ...
                        appendMessages(classificationrules.getMessages());
                        optionalNotUsed = optionalNotUsed &&
                                classificationrules.getOptionalNotUsed();
                }

                if (DebugIndicator.ON)
                {
                        boolean flag18 = flag2 && flag && flag1 && flag3 && flag4 && flag5 &&
                                flag6 && flag7 && flag8;
                        System.out.println("returning ->" + flag18);
                }

                return flag2 && flag && flag1 && flag3 && flag4 && flag5 && flag6 &&
                        flag7 && flag8;
        }
