...
public class TaxonpathRules extends MetadataUtil
{
        ...
        public boolean verifyAssetMandatory()
        {
                ...
                {
                        System.out.println("element " + elemNum + " <taxonpath> has no " +
        ...
        public boolean verifyAssetOptional()
        {
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s.equalsIgnoreCase("source"))
                        {
                                if (!flag2)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "TaxonpathRules::verifyAssetOptional()",
                                                "Testing element " + elemNum + ".1 <source>...");
                                        setMessage(MessageType.INFO,
                                                "TaxonpathRules::verifyAssetOptional()",
                                                "Testing element " + elemNum +
                                                        ".1 <source> for multiplicity...");
                                        ...
                                        if (j > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "TaxonpathRules::verifyAssetOptional()",
                                                        "More than 1 <source> element was found .. 0 or 1 allowed");
                                                flag = false;
                                        }
                                        else if (j == 1)
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "TaxonpathRules::verifyAssetOptional()",
                                                        "0 or 1 <source> element was found");
                        ...
                        if (!flag3)
                        {
                                ...
                                setMessage(MessageType.INFO,
                                        "TaxonpathRules::verifyAssetOptional()",
                                        "Testing element " + elemNum + ".2 <taxon>...");
                                setMessage(MessageType.INFO,
                                        "TaxonpathRules::verifyAssetOptional()",
                                        "Testing element " + elemNum + ".2 <taxon> for " +
                                                "multiplicity...");
                                ...
                                if (k > 15)
                                {
                                        setMessage(MessageType.WARNING,
                                                "TaxonpathRules::verifyAssetOptional()",
                                                "More than 15 <taxon> elements were found");
                                }
                                else
                                {
                                        setMessage(MessageType.PASSED,
                                                "TaxonpathRules::verifyAssetOptional()",
                                                "15 or less <taxon> elements were found");
                                }
                ...
                for (int i = 0; i < nodelist.getLength(); i++)
                {
                        ...
                        if (s1.equalsIgnoreCase("id"))
                        {
                                if (!flag2)
                                {
                                        setMessage(MessageType.OTHER, "", "");
                                        setMessage(MessageType.INFO,
                                                "TaxonpathRules::verifyTaxon()",
                                                "Testing element " + s + ".1 <id>...");
                                        setMessage(MessageType.INFO,
                                                "TaxonpathRules::verifyTaxon()",
                                                "Testing element " + s + ".1 <id> for multiplicity...");
                                        ...
                                        if (j > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "TaxonpathRules::verifyTaxon()",
                                                        "More than 1 <id> element was found .. 0 or 1 allowed");
                                                flag = false;
                                        }
                                        else if (j == 1)
                                        {
                        ...
                        if (s1.equalsIgnoreCase("entry"))
                        {
                                if (!flag3)
                                {
                                        ...
                                        setMessage(MessageType.INFO,
                                                "TaxonpathRules::verifyTaxon()",
                                                "Testing element " + s + ".2 <entry>...");
                                        setMessage(MessageType.INFO,
                                                "TaxonpathRules::verifyTaxon()",
                                                "Testing element " + s +
                                                        ".2 <entry> for multiplicity...");
                                        ...
                                        if (k > 1)
                                        {
                                                setMessage(MessageType.FAILED,
                                                        "TaxonpathRules::verifyTaxon()",
                                                        "More than 1 <entry> element was found .. 0 or 1 allowed");
                                                flag1 = false;
                                        }
                                        else if (k == 1)
                                        {
                                                setMessage(MessageType.PASSED,
                                                        "TaxonpathRules::verifyTaxon()",
                                                        "0 or 1 <entry> element was found");
        ...
        private boolean verifyId(Node node, String s)
        {
                ...
                if (nodelist != null)
                {
                        ...
                        {
                                flag = false;
                                setMessage(MessageType.FAILED, "TaxonpathRules::verifyId()",
                                        "No data was found in element <id> and fails the minimum character length test");
                        }
                        else if (i == 1)
                        {
                                for (int k = 0; k < nodelist.getLength(); k++)
                                {
                                        ...
                                        {
                                                setMessage(MessageType.INFO,
                                                        "TaxonpathRules::verifyId()",
                                                        "Testing text of element " + s +
                                                                " <id> for character length...");
                                                ...
                                                else if (s2.length() < 1)
                                                {
                                                        ...
                                                        setMessage(MessageType.FAILED,
                                                                ...
                                                                "No text was found in element " + s +
                                                                        " <id> and fails the minimum character " +
                                                                        "length test");
                                                }
                                                else
                                                {
                                                        setMessage(MessageType.PASSED,
                                                                "TaxonpathRules::verifyId()",
                                                                "Character length for element  <id> has been verified");
                                                }
                                        }
                                }
                        }
                        else
                        {
                                ...
                                setMessage(MessageType.FAILED, "TaxonpathRules::verifyId()",
                                        "Too many text strings were found in <id> and fails the test");
                        }
                }
