...
public class CMICategory implements Serializable
{
         ...
         * *************************************************************************
         */
        public String determineElementValue(Object o, String element,
         ...
         * *************************************************************************
         */
        public void doSet(Object o, String element, String value,
                          DMErrorManager dmErrorMgr)
        {
                if (true)
                {
         ...
         * *************************************************************************
         */
        protected boolean validateType(Object o, Element e, String element,
                                       String value, DMErrorManager dmErrorMgr)
        {
                if (true)
                {
                ...
                Class[] parameterTypes = new Class[]{e.getClass(), String.class};
                ...
                try
                {
                        ...
                        // and parameter types
                        Boolean theResult = (Boolean) theMethod.invoke(dmValidator,
                                arguments);
