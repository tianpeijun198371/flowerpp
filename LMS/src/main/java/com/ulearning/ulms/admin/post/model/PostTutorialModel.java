 ...
 */
public class PostTutorialModel implements Serializable
{
        /**
         * identifier field
         */
         ...
         * full constructor
         */
        public PostTutorialModel(int relationID, int tutorialID, int type, int sort)
        {
