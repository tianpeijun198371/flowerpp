 ...
 */
public class NewDocumentModel implements Serializable
{
        ...
        public NewDocumentModel()
        {
        }

        public NewDocumentModel(String docName, int aspID, int parentID, int relationID, String isContent,
        ...
        {
                return ClobUtil.getString(this.contentClob);
        }
