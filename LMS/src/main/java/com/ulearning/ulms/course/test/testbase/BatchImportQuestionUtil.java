                        ...
                        for (int i = 3; i <= rowCount; i++)
                        {
                                ...
                                DebugUtil.print(
                                        "[BatchImportQuestionUtil]==============answer=" +
                                                answer.toUpperCase());
                                DebugUtil.print("[BatchImportQuestionUtil]==============total=" +
                                        row.getCell((short) 1).getStringCellValue() +
                                        row.getCell((short) 3).getNumericCellValue());

                                if (type.equals("") || hardLevel.equals("") ||
                                        score.equals("") || title.equals("") ||
                                        answer.equals(""))
                                {
        ...
        /*
          public static void main(String [] arg)
          {
                BatchImportQuestionUtil mm = new BatchImportQuestionUtil();
                  String file = "d:\\questionimport.xls";
