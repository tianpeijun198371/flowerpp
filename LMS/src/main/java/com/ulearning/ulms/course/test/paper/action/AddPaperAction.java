...
public class AddPaperAction extends Action
{
                ...
                throws Exception
        {
                ...
                if (!pf.getBeginTime().equals(""))
                {
                        ...
                        pf.setStartTime(DateTimeUtil.toDate(tmp[1], tmp[2], tmp[0], tmp[3],
                                tmp[4], "0"));
                        System.out.println(DateTimeUtil.toDate(tmp[1], tmp[2], tmp[0],
                                tmp[3], tmp[4], "0"));
                }
                ...
                request.setAttribute("paperScope", String.valueOf(pf.getType()));
                request.setAttribute("publicCourseID", String.valueOf(pf.getCourseID()));
